...
void set_vehicle_tyre_smoke_color(int veh, int r, int g, int b);
...
void set_entity_coords2(int PedID, Vector3 *PosCoords, int unk1, int unk2, int unk3, int unk4);
...
/*
if it gives an error void these out
*/
namespace PLAYER
{
    ...
    static void GET_PLAYER_RGB_COLOUR(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x6EF43BBB, p0, p1, p2, p3); } // 0x6EF43BBB
    static Any GET_NUMBER_OF_PLAYERS() { return invoke<Any>(0x4C1B8867); } // 0x4C1B8867
    static int GET_PLAYER_TEAM(Player player) { return invoke<int>(0x9873E404, player); } // 0x9873E404
    static void SET_PLAYER_TEAM(Player player, int teamid) { invoke<Void>(0x725ADCF2, player, teamid); } // 0x725ADCF2
    static string GET_PLAYER_NAME(Player player) { return invoke<string>(0x406B4B20, player); } // 0x406B4B20
    static float GET_WANTED_LEVEL_RADIUS(Player player) { return invoke<float>(0x1CF7D7DA, player); } // 0x1CF7D7DA
    static Vector3 GET_PLAYER_WANTED_CENTRE_POSITION(Player p) { return invoke<Vector3>(0x821F2D2C, p); } // 0x821F2D2C
    static void SET_PLAYER_WANTED_CENTRE_POSITION(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xF261633A, p0, p1, p2, p3); } // 0xF261633A
    static Any GET_WANTED_LEVEL_THRESHOLD(Any p0) { return invoke<Any>(0xD9783F6B, p0); } // 0xD9783F6B
    static void SET_PLAYER_WANTED_LEVEL(Player p, int level, BOOL unkb) { invoke<Void>(0xB7A0914B, p, level, unkb); } // 0xB7A0914B
    static void SET_PLAYER_WANTED_LEVEL_NO_DROP(Player p, int level, BOOL unkb) { invoke<Void>(0xED6F44F5, p, level, unkb); } // 0xED6F44F5
    static void SET_PLAYER_WANTED_LEVEL_NOW(Player p, BOOL unkb) { invoke<Void>(0xAF3AFD83, p, unkb); } // 0xAF3AFD83
    static BOOL ARE_PLAYER_FLASHING_STARS_ABOUT_TO_DROP(Player p) { return invoke<BOOL>(0xE13A71C7, p); } // 0xE13A71C7
    static BOOL ARE_PLAYER_STARS_GREYED_OUT(Player p) { return invoke<BOOL>(0x5E72AB72, p); } // 0x5E72AB72
    static void SET_DISPATCH_COPS_FOR_PLAYER(Any p0, Any p1) { invoke<Void>(0x48A18913, p0, p1); } // 0x48A18913
    static BOOL IS_PLAYER_WANTED_LEVEL_GREATER(Player player, int level) { return invoke<BOOL>(0x589A2661, player, level); } // 0x589A2661
    static void CLEAR_PLAYER_WANTED_LEVEL(Player p) { invoke<Void>(0x54EA5BCC, p); } // 0x54EA5BCC
    ...
    static void SET_PLAYER_CONTROL(Player p, BOOL b1, BOOL b2) { invoke<Void>(0xD17AFCD8, p, b1, b2); } // 0xD17AFCD8
    static int GET_PLAYER_WANTED_LEVEL(Player p) { return invoke<int>(0xBDCDD163, p); } // 0xBDCDD163
    static void SET_MAX_WANTED_LEVEL(int level) { invoke<Void>(0x665A06F5, level); } // 0x665A06F5 // Cannot be greater than 5
    static void SET_POLICE_RADAR_BLIPS(BOOL set) { invoke<Void>(0x8E114B10, set); } // 0x8E114B10
    static void SET_POLICE_IGNORE_PLAYER(Player p, BOOL ignore) { invoke<Void>(0xE6DE71B7, p, ignore); } // 0xE6DE71B7
    static BOOL IS_PLAYER_PLAYING(Player p) { return invoke<BOOL>(0xE15D777F, p); } // 0xE15D777F
    static void SET_EVERYONE_IGNORE_PLAYER(Player p, BOOL ignore) { invoke<Void>(0xC915285E, p, ignore); } // 0xC915285E
    static void SET_ALL_RANDOM_PEDS_FLEE(Player player, BOOL flee) { invoke<Void>(0x49EAE968, player, flee); } // 0x49EAE968
    static void SET_ALL_RANDOM_PEDS_FLEE_THIS_FRAME(Player player) { invoke<Void>(0xBF974891, player); } // 0xBF974891
    static void _0x274631FE(Player player, BOOL p1) { invoke<Void>(0x274631FE, player, p1); } // 0x274631FE
    static void _0x02DF7AF4(Any p0) { invoke<Void>(0x02DF7AF4, p0); } // 0x02DF7AF4
    static void _0x9CEA7458(Any p0) { invoke<Void>(0x9CEA7458, p0); } // 0x9CEA7458
    static void SET_IGNORE_LOW_PRIORITY_SHOCKING_EVENTS(Any p0, Any p1) { invoke<Void>(0xA3D675ED, p0, p1); } // 0xA3D675ED
    static void SET_WANTED_LEVEL_MULTIPLIER(Any p0) { invoke<Void>(0x1359292F, p0); } // 0x1359292F
    static void SET_WANTED_LEVEL_DIFFICULTY(Any p0, Any p1) { invoke<Void>(0xB552626C, p0, p1); } // 0xB552626C
    static void RESET_WANTED_LEVEL_DIFFICULTY(Any p0) { invoke<Void>(0xA64C378D, p0); } // 0xA64C378D
    static void START_FIRING_AMNESTY(Any p0) { invoke<Void>(0x5F8A22A6, p0); } // 0x5F8A22A6
    static void REPORT_CRIME(Any p0, Any p1, Any p2) { invoke<Void>(0xD8EB3A44, p0, p1, p2); } // 0xD8EB3A44
    ...
    static void _0x3A7E5FB6(Any p0) { invoke<Void>(0x3A7E5FB6, p0); } // 0x3A7E5FB6
    ...
    static BOOL CAN_PLAYER_START_MISSION(Player p) { return invoke<BOOL>(0x39E3CB3F, p); } // 0x39E3CB3F
    static BOOL IS_PLAYER_READY_FOR_CUTSCENE(Player p) { return invoke<BOOL>(0xBB77E9CD, p); } // 0xBB77E9CD
    static BOOL IS_PLAYER_TARGETTING_ENTITY(Any p0, Any p1) { return invoke<BOOL>(0xF3240B77, p0, p1); } // 0xF3240B77
    static Any GET_PLAYER_TARGET_ENTITY(Any p0, Any p1) { return invoke<Any>(0xF6AAA2D7, p0, p1); } // 0xF6AAA2D7
    static BOOL IS_PLAYER_FREE_AIMING(Any p0) { return invoke<BOOL>(0x1DEC67B7, p0); } // 0x1DEC67B7
    static BOOL IS_PLAYER_FREE_AIMING_AT_ENTITY(Any p0, Any p1) { return invoke<BOOL>(0x7D80EEAA, p0, p1); } // 0x7D80EEAA
    static Any _0x8866D9D0(Any p0, Any p1) { return invoke<Any>(0x8866D9D0, p0, p1); } // 0x8866D9D0
    ...
    static Any GET_MAX_WANTED_LEVEL() { return invoke<Any>(0x457F1E44); } // 0x457F1E44
    static BOOL IS_PLAYER_TARGETTING_ANYTHING(Any p0) { return invoke<BOOL>(0x456DB50D, p0); } // 0x456DB50D
    static void SET_PLAYER_SPRINT(Any p0, Any p1) { invoke<Void>(0x7DD7900C, p0, p1); } // 0x7DD7900C
    static void RESET_PLAYER_STAMINA(Any p0) { invoke<Void>(0xC0445A9C, p0); } // 0xC0445A9C
    ...
    static Any GET_PLAYER_GROUP(Any p0) { return invoke<Any>(0xA5EDCDE8, p0); } // 0xA5EDCDE8
    static int GET_PLAYER_MAX_ARMOUR(Player p) { return invoke<int>(0x02A50657, p); } // 0x02A50657
    static BOOL IS_PLAYER_CONTROL_ON(Player p) { return invoke<BOOL>(0x618857F2, p); } // 0x618857F2
    static BOOL IS_PLAYER_SCRIPT_CONTROL_ON(Player p) { return invoke<BOOL>(0x61B00A84, p); } // 0x61B00A84
    ...
    static Player INT_TO_PLAYERINDEX(Player player) { return invoke<Player>(0x98DD98F1, player); } // 0x98DD98F1
    static Player _INT_TO_PLAYERINDEX(Player player) { return invoke<Player>(0x98F3B274, player); } // 0x98F3B274
    ...
    static Any GET_TIME_SINCE_PLAYER_DROVE_AGAINST_TRAFFIC(Any p0) { return invoke<Any>(0x9F27D00E, p0); } // 0x9F27D00E
    ...
    static Player _PLAYER_ID() { return invoke<Player>(0x8DD5B838); } // 0x8DD5B838
    ...
    static Any GIVE_ACHIEVEMENT_TO_PLAYER(Any p0) { return invoke<Any>(0x822BC992, p0); } // 0x822BC992
    static BOOL HAS_ACHIEVEMENT_BEEN_PASSED(Any p0) { return invoke<BOOL>(0x136A5BE9, p0); } // 0x136A5BE9
    ...
    static void SET_PLAYER_INVINCIBLE(Player p, BOOL b) { invoke<Void>(0xDFB9A2A2, p, b); } // 0xDFB9A2A2
    static BOOL GET_PLAYER_INVINCIBLE(Player p) { return invoke<BOOL>(0x680C90EE, p); } // 0x680C90EE
    static void _0x00563E0D(Any p0, Any p1) { invoke<Void>(0x00563E0D, p0, p1); } // 0x00563E0D
    static void REMOVE_PLAYER_HELMET(Any p0, Any p1) { invoke<Void>(0x6255F3B4, p0, p1); } // 0x6255F3B4
    ...
    static void SET_PLAYER_TARGETING_MODE(Any p0) { invoke<Void>(0x61CAE253, p0); } // 0x61CAE253
    ...
    static void SET_AIR_DRAG_MULTIPLIER_FOR_PLAYERS_VEHICLE(Player p, float m) { invoke<Void>(0xF20F72E5, p, m); } // 0xF20F72E5
    static void _SET_SWIM_SPEED_MULTIPLIER(Player p, float m) { invoke<Void>(0xB986FF47, p, m); } // 0xB986FF47
    static void _SET_MOVE_SPEED_MULTIPLIER(Player p, float m) { invoke<Void>(0x825423C2, p, m); } // 0x825423C2
    ...
    static void SET_PLAYER_FORCED_AIM(Any p0, Any p1) { invoke<Void>(0x94E42E2E, p0, p1); } // 0x94E42E2E
    ...
    static void DISABLE_PLAYER_FIRING(Any p0, Any p1) { invoke<Void>(0x30CB28CB, p0, p1); } // 0x30CB28CB
    static void _0xCCD937E7(Any p0, Any p1) { invoke<Void>(0xCCD937E7, p0, p1); } // 0xCCD937E7
    static void SET_PLAYER_MAX_ARMOUR(Player p, int val) { invoke<Void>(0xC6C3C53B, p, val); } // 0xC6C3C53B
    ...
    static Any GET_PLAYER_CURRENT_STEALTH_NOISE(Any p0) { return invoke<Any>(0xC3B02362, p0); } // 0xC3B02362
    static void _0x45514731(Any p0, Any p1) { invoke<Void>(0x45514731, p0, p1); } // 0x45514731
    static void SET_PLAYER_WEAPON_DAMAGE_MODIFIER(Any p0, Any p1) { invoke<Void>(0xB02C2F39, p0, p1); } // 0xB02C2F39
    static void _0xAE446344(Any p0, Any p1) { invoke<Void>(0xAE446344, p0, p1); } // 0xAE446344
    ...
    static void SET_PLAYER_VEHICLE_DAMAGE_MODIFIER(Any p0, Any p1) { invoke<Void>(0x823ECA63, p0, p1); } // 0x823ECA63
    ...
    static void _0xD79D5D1B(Any p0, Any p1) { invoke<Void>(0xD79D5D1B, p0, p1); } // 0xD79D5D1B
    ...
    static void SET_PLAYER_NOISE_MULTIPLIER(Any p0, Any p1) { invoke<Void>(0x15786DD1, p0, p1); } // 0x15786DD1
    ...
    static BOOL IS_PLAYER_RIDING_TRAIN(Any p0) { return invoke<BOOL>(0x9765E71D, p0); } // 0x9765E71D
    ...
    static void _0x9254249D(Any p0, Any p1, Any p2) { invoke<Void>(0x9254249D, p0, p1, p2); } // 0x9254249D
    // 0xFD60F5AB -- no params/results data
    static void _0x8C6E611D(Any p0) { invoke<Void>(0x8C6E611D, p0); } // 0x8C6E611D
}
namespace ENTITY
{
    static BOOL DOES_ENTITY_EXIST(Entity e) { return invoke<BOOL>(0x3AC90869, e); } // 0x3AC90869
    static Any _0xACFEB3F9(Any p0, Any p1) { return invoke<Any>(0xACFEB3F9, p0, p1); } // 0xACFEB3F9
    static BOOL DOES_ENTITY_HAVE_DRAWABLE(Any p0) { return invoke<BOOL>(0xA5B33300, p0); } // 0xA5B33300
    static BOOL DOES_ENTITY_HAVE_PHYSICS(Any p0) { return invoke<BOOL>(0x9BCD2979, p0); } // 0x9BCD2979
    static BOOL HAS_ENTITY_ANIM_FINISHED(Any p0, Any p1, Any p2, Any p3) { return invoke<BOOL>(0x1D9CAB92, p0, p1, p2, p3); } // 0x1D9CAB92
    static BOOL HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(Any p0) { return invoke<BOOL>(0x6B74582E, p0); } // 0x6B74582E
    static BOOL HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(Any p0) { return invoke<BOOL>(0x53FD4A25, p0); } // 0x53FD4A25
    static BOOL HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(Any p0) { return invoke<BOOL>(0x878C2CE0, p0); } // 0x878C2CE0
    ...
    static BOOL HAS_ENTITY_COLLIDED_WITH_ANYTHING(Any p0) { return invoke<BOOL>(0x662A2F41, p0); } // 0x662A2F41
    ...
    static Any GET_ENTITY_ATTACHED_TO(Any p0) { return invoke<Any>(0xFE1589F9, p0); } // 0xFE1589F9
    static Vector3 GET_ENTITY_COORDS(Entity e, BOOL b) { return invoke<Vector3>(0x1647F1CB, e, b); } // 0x1647F1CB
    static Vector3 GET_ENTITY_FORWARD_VECTOR(Entity e) { return invoke<Vector3>(0x84DCECBF, e); } // 0x84DCECBF
    static float GET_ENTITY_FORWARD_X(Entity e) { return invoke<float>(0x49FAE914, e); } // 0x49FAE914
    static float GET_ENTITY_FORWARD_Y(Entity e) { return invoke<float>(0x9E2F917C, e); } // 0x9E2F917C
    static float GET_ENTITY_HEADING(Entity e) { return invoke<float>(0x972CC383, e); } // 0x972CC383
    static int GET_ENTITY_HEALTH(Entity e) { return invoke<int>(0x8E3222B7, e); } // 0x8E3222B7
    static int GET_ENTITY_MAX_HEALTH(Entity e) { return invoke<int>(0xC7AE6AA1, e); } // 0xC7AE6AA1
    static void SET_ENTITY_MAX_HEALTH(Any p0, Any p1) { invoke<Void>(0x96F84DF8, p0, p1); } // 0x96F84DF8
    ...
    static Any GET_ENTITY_HEIGHT_ABOVE_GROUND(Any p0) { return invoke<Any>(0x57F56A4D, p0); } // 0x57F56A4D
    static void GET_ENTITY_MATRIX(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0xEB9EB001, p0, p1, p2, p3, p4); } // 0xEB9EB001
    static Hash GET_ENTITY_MODEL(Entity e) { return invoke<Hash>(0xDAFCB3EC, e); } // 0xDAFCB3EC
    ...
    static Vector3 GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Entity e, float x, float y, float z) { return invoke<Vector3>(0xABCF043A, e, x, y, z); } // 0xABCF043A
    static Any GET_ENTITY_PITCH(Any p0) { return invoke<Any>(0xFCE6ECE5, p0); } // 0xFCE6ECE5
    static void GET_ENTITY_QUATERNION(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x5154EC90, p0, p1, p2, p3, p4); } // 0x5154EC90
    static Any GET_ENTITY_ROLL(Any p0) { return invoke<Any>(0x36610842, p0); } // 0x36610842
    static Vector3 GET_ENTITY_ROTATION(Entity e, int mode) { return invoke<Vector3>(0x8FF45B04, e, mode); } // 0x8FF45B04
    static Vector3 GET_ENTITY_ROTATION_VELOCITY(Entity e) { return invoke<Vector3>(0x9BF8A73F, e); } // 0x9BF8A73F
    static Any GET_ENTITY_SCRIPT(Any p0, Any p1) { return invoke<Any>(0xB7F70784, p0, p1); } // 0xB7F70784
    static float GET_ENTITY_SPEED(Entity e) { return invoke<float>(0x9E1E4798, e); } // 0x9E1E4798
    ...
    static Vector3 GET_ENTITY_VELOCITY(Any p0) { return invoke<Vector3>(0xC14C9B6B, p0); } // 0xC14C9B6B
    ...
    static Any GET_NEAREST_PLAYER_TO_ENTITY(Any p0) { return invoke<Any>(0xCE17FDEC, p0); } // 0xCE17FDEC
    static Any GET_ENTITY_TYPE(Any p0) { return invoke<Any>(0x0B1BD08D, p0); } // 0x0B1BD08D
    static BOOL IS_AN_ENTITY(Any p0) { return invoke<BOOL>(0xD4B9715A, p0); } // 0xD4B9715A
    static BOOL IS_ENTITY_A_PED(Any p0) { return invoke<BOOL>(0x55D33EAB, p0); } // 0x55D33EAB
    static BOOL IS_ENTITY_A_MISSION_ENTITY(Any p0) { return invoke<BOOL>(0x2632E124, p0); } // 0x2632E124
    static BOOL IS_ENTITY_A_VEHICLE(Any p0) { return invoke<BOOL>(0xBE800B01, p0); } // 0xBE800B01
    static BOOL IS_ENTITY_AN_OBJECT(Any p0) { return invoke<BOOL>(0x3F52E561, p0); } // 0x3F52E561
    static BOOL IS_ENTITY_AT_COORD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9) { return invoke<BOOL>(0xD749B606, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); } // 0xD749B606
    static BOOL IS_ENTITY_AT_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { return invoke<BOOL>(0xDABDCB52, p0, p1, p2, p3, p4, p5, p6, p7); } // 0xDABDCB52
    ...
    static BOOL IS_ENTITY_DEAD(Entity e) { return invoke<BOOL>(0xB6F7CBAC, e); } // 0xB6F7CBAC
    static BOOL IS_ENTITY_IN_AIR(Entity e) { return invoke<BOOL>(0xA4157987, e); } // 0xA4157987
    ...
    static BOOL IS_ENTITY_IN_WATER(Entity e) { return invoke<BOOL>(0x4C3C2508, e); } // 0x4C3C2508
    ...
    static BOOL IS_ENTITY_ON_SCREEN(Entity e) { return invoke<BOOL>(0xC1FEC5ED, e); } // 0xC1FEC5ED
    static BOOL IS_ENTITY_PLAYING_ANIM(Any p0, Any p1, Any p2, Any p3) { return invoke<BOOL>(0x0D130D34, p0, p1, p2, p3); } // 0x0D130D34
    static BOOL IS_ENTITY_STATIC(Entity e) { return invoke<BOOL>(0x928E12E9, e); } // 0x928E12E9
    static BOOL IS_ENTITY_TOUCHING_ENTITY(Any p0, Any p1) { return invoke<BOOL>(0x6B931477, p0, p1); } // 0x6B931477
    ...
    static BOOL IS_ENTITY_VISIBLE(Entity e) { return invoke<BOOL>(0x120B4ED5, e); } // 0x120B4ED5
    static BOOL IS_ENTITY_VISIBLE_TO_SCRIPT(Entity e) { return invoke<BOOL>(0x5D240E9D, e); } // 0x5D240E9D
    static BOOL IS_ENTITY_OCCLUDED(Entity e) { return invoke<BOOL>(0x46BC5B40, e); } // 0x46BC5B40
    ...
    static void APPLY_FORCE_TO_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13) { invoke<Void>(0xC1C0855A, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13); } // 0xC1C0855A
    static void ATTACH_ENTITY_TO_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13, Any p14) { invoke<Void>(0xEC024237, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14); } // 0xEC024237
    static void ATTACH_ENTITY_TO_ENTITY_PHYSICALLY(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13, Any p14, Any p15, Any p16, Any p17, Any p18) { invoke<Void>(0x0547417F, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18); } // 0x0547417F
    ...
    static void CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Any p0) { invoke<Void>(0x2B83F43B, p0); } // 0x2B83F43B
    static void DELETE_ENTITY(Any p0) { invoke<Void>(0xFAA3D236, p0); } // 0xFAA3D236
    static void DETACH_ENTITY(Any p0, Any p1, Any p2) { invoke<Void>(0xC8EFCB41, p0, p1, p2); } // 0xC8EFCB41
    static void FREEZE_ENTITY_POSITION(Any p0, Any p1) { invoke<Void>(0x65C16D57, p0, p1); } // 0x65C16D57
    ...
    static void SET_ENTITY_AS_MISSION_ENTITY(Any p0, Any p1, Any p2) { invoke<Void>(0x5D1F9E0F, p0, p1, p2); } // 0x5D1F9E0F
    static void SET_ENTITY_AS_NO_LONGER_NEEDED(Entity *e) { invoke<Void>(0xADF2267C, e); } // 0xADF2267C
    static void SET_PED_AS_NO_LONGER_NEEDED(Ped *p) { invoke<Void>(0x9A388380, p); } // 0x9A388380
    static void SET_VEHICLE_AS_NO_LONGER_NEEDED(Vehicle *v) { invoke<Void>(0x9B0E10BE, v); } // 0x9B0E10BE
    static void SET_OBJECT_AS_NO_LONGER_NEEDED(Object *o) { invoke<Void>(0x3F6B949F, o); } // 0x3F6B949F
    static void SET_ENTITY_CAN_BE_DAMAGED(Entity e, BOOL b) { invoke<Void>(0x60B6E744, e, b); } // 0x60B6E744
    ...
    static void SET_ENTITY_COLLISION(Any p0, Any p1, Any p2) { invoke<Void>(0x139FD37D, p0, p1, p2); } // 0x139FD37D
    static void SET_ENTITY_COORDS(Entity e, float x, float y, float z, BOOL b1, BOOL b2, BOOL b3, BOOL b4) { invoke<Void>(0xDF70B41B, e, x, y, z, b1, b2, b3, b4); } // 0xDF70B41B
    static void SET_ENTITY_COORDS_NO_OFFSET(Entity e, float x, float y, float z, BOOL b1, BOOL b2, BOOL b3) { invoke<Void>(0x4C83DE8D, e, x, y, z, b1, b2, b3); } // 0x4C83DE8D
    static void SET_ENTITY_DYNAMIC(Any p0, Any p1) { invoke<Void>(0x236F525B, p0, p1); } // 0x236F525B
    static void SET_ENTITY_HEADING(Entity e, float heading) { invoke<Void>(0xE0FF064D, e, heading); } // 0xE0FF064D
    static void SET_ENTITY_HEALTH(Entity e, int health) { invoke<Void>(0xFBCD1831, e, health); } // 0xFBCD1831
    static void SET_ENTITY_INVINCIBLE(Entity e, BOOL b) { invoke<Void>(0xC1213A21, e, b); } // 0xC1213A21
    ...
    static void SET_ENTITY_LOAD_COLLISION_FLAG(Any p0, Any p1) { invoke<Void>(0xC52F295B, p0, p1); } // 0xC52F295B
    ...
    static void SET_ENTITY_PROOFS(Entity e, BOOL b1, BOOL b2, BOOL b3, BOOL b4, BOOL b5, BOOL b6, BOOL b7, BOOL b8) { invoke<Void>(0x7E9EAB66, e, b1, b2, b3, b4, b5, b6, b7, b8); } // 0x7E9EAB66
    ...
    static void SET_ENTITY_ROTATION(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x0A345EFE, p0, p1, p2, p3, p4, p5); } // 0x0A345EFE
    static void SET_ENTITY_VISIBLE(Entity e, BOOL b) { invoke<Void>(0xD043E8E1, e, b); } // 0xD043E8E1
    static void SET_ENTITY_VELOCITY(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xFF5A1988, p0, p1, p2, p3); } // 0xFF5A1988
    static void SET_ENTITY_HAS_GRAVITY(Entity e, BOOL b) { invoke<Void>(0xE2F262BF, e, b); } // 0xE2F262BF
    static void SET_ENTITY_LOD_DIST(Any p0, Any p1) { invoke<Void>(0xD7ACC7AD, p0, p1); } // 0xD7ACC7AD
    static void SET_ENTITY_ALPHA(Any p0, Any p1, Any p2) { invoke<Void>(0xAE667CB0, p0, p1, p2); } // 0xAE667CB0
    static Any GET_ENTITY_ALPHA(Any p0) { return invoke<Any>(0x1560B017, p0); } // 0x1560B017
    static void RESET_ENTITY_ALPHA(Any p0) { invoke<Void>(0x8A30761C, p0); } // 0x8A30761C
    ...
    static void SET_ENTITY_NO_COLLISION_ENTITY(Any p0, Any p1, Any p2) { invoke<Void>(0x1E11BFE9, p0, p1, p2); } // 0x1E11BFE9
...
namespace PED
{
    static Any CREATE_PED(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { return invoke<Any>(0x0389EF71, p0, p1, p2, p3, p4, p5, p6, p7); } // 0x0389EF71
    static void DELETE_PED(Any p0) { invoke<Void>(0x13EFB9A0, p0); } // 0x13EFB9A0
    static Any CLONE_PED(Any p0, Any p1, Any p2, Any p3) { return invoke<Any>(0x8C8A8D6E, p0, p1, p2, p3); } // 0x8C8A8D6E
    static void _0xFC70EEC7(Any p0, Any p1) { invoke<Void>(0xFC70EEC7, p0, p1); } // 0xFC70EEC7
    static BOOL IS_PED_IN_VEHICLE(Any p0, Any p1, Any p2) { return invoke<BOOL>(0x7DA6BC83, p0, p1, p2); } // 0x7DA6BC83
    static BOOL IS_PED_IN_MODEL(Any p0, Any p1) { return invoke<BOOL>(0xA6438D4B, p0, p1); } // 0xA6438D4B
    static BOOL IS_PED_IN_ANY_VEHICLE(Ped p, BOOL unkb) { return invoke<BOOL>(0x3B0171EE, p, unkb); } // 0x3B0171EE
    ...
    static BOOL IS_PED_INJURED(Any p0) { return invoke<BOOL>(0x2530A087, p0); } // 0x2530A087
    static BOOL IS_PED_HURT(Any p0) { return invoke<BOOL>(0x69DFA0AF, p0); } // 0x69DFA0AF
    static BOOL IS_PED_FATALLY_INJURED(Any p0) { return invoke<BOOL>(0xBADA0093, p0); } // 0xBADA0093
    static Any _0xCBDB7739(Any p0, Any p1) { return invoke<Any>(0xCBDB7739, p0, p1); } // 0xCBDB7739
    static BOOL IS_CONVERSATION_PED_DEAD(Any p0) { return invoke<BOOL>(0x1FA39EFE, p0); } // 0x1FA39EFE
    static BOOL IS_PED_AIMING_FROM_COVER(Any p0) { return invoke<BOOL>(0xDEBAB2AF, p0); } // 0xDEBAB2AF
    static BOOL IS_PED_RELOADING(Any p0) { return invoke<BOOL>(0x961E1745, p0); } // 0x961E1745
    static BOOL IS_PED_A_PLAYER(Any p0) { return invoke<BOOL>(0x404794CA, p0); } // 0x404794CA
    static Any CREATE_PED_INSIDE_VEHICLE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { return invoke<Any>(0x3000F092, p0, p1, p2, p3, p4, p5); } // 0x3000F092
    ...
    static BOOL IS_PED_IN_MELEE_COMBAT(Any p0) { return invoke<BOOL>(0xFD7814A5, p0); } // 0xFD7814A5
    static BOOL IS_PED_STOPPED(Any p0) { return invoke<BOOL>(0xA0DC0B87, p0); } // 0xA0DC0B87
    ...
    static BOOL IS_PED_SHOOTING(Any p0) { return invoke<BOOL>(0xE7C3405E, p0); } // 0xE7C3405E
    static void SET_PED_ACCURACY(Any p0, Any p1) { invoke<Void>(0x6C17122E, p0, p1); } // 0x6C17122E
    static Any GET_PED_ACCURACY(Any p0) { return invoke<Any>(0x0A2A0AA0, p0); } // 0x0A2A0AA0
    static BOOL IS_PED_MODEL(Any p0, Any p1) { return invoke<BOOL>(0x5F1DDFCB, p0, p1); } // 0x5F1DDFCB
    static void EXPLODE_PED_HEAD(Any p0, Any p1) { invoke<Void>(0x05CC1380, p0, p1); } // 0x05CC1380
    static void REMOVE_PED_ELEGANTLY(Any p0) { invoke<Void>(0x4FFB8C6C, p0); } // 0x4FFB8C6C
    static void ADD_ARMOUR_TO_PED(Ped p, int armour) { invoke<Void>(0xF686B26E, p, armour); } // 0xF686B26E
    static void SET_PED_ARMOUR(Any p0, Any p1) { invoke<Void>(0x4E3A0CC4, p0, p1); } // 0x4E3A0CC4
    static void SET_PED_INTO_VEHICLE(Ped ped, Vehicle veh, int unk) { invoke<Void>(0x07500C79, ped, veh, unk); } // 0x07500C79
    ...
    static Any CREATE_RANDOM_PED(Any p0, Any p1, Any p2) { return invoke<Any>(0x5A949543, p0, p1, p2); } // 0x5A949543
    static Any CREATE_RANDOM_PED_AS_DRIVER(Any p0, Any p1) { return invoke<Any>(0xB927CE9A, p0, p1); } // 0xB927CE9A
    ...
    static Any GET_VEHICLE_PED_IS_IN(Any p0, Any p1) { return invoke<Any>(0xAFE92319, p0, p1); } // 0xAFE92319
    static void RESET_PED_LAST_VEHICLE(Any p0) { invoke<Void>(0x5E3B5942, p0); } // 0x5E3B5942
    static void SET_PED_DENSITY_MULTIPLIER_THIS_FRAME(float m) { invoke<Void>(0x039C82BB, m); } // 0x039C82BB
    static void SET_SCENARIO_PED_DENSITY_MULTIPLIER_THIS_FRAME(float m1, float m2) { invoke<Void>(0x2909ABF0, m1, m2); } // 0x2909ABF0
    ...
    static BOOL IS_PED_ON_SPECIFIC_VEHICLE(Any p0, Any p1) { return invoke<BOOL>(0x63CB4603, p0, p1); } // 0x63CB4603
    static void SET_PED_MONEY(Any p0, Any p1) { invoke<Void>(0x40D90BF2, p0, p1); } // 0x40D90BF2
    static Any GET_PED_MONEY(Any p0) { return invoke<Any>(0xEB3C4C7E, p0); } // 0xEB3C4C7E
    ...
    static BOOL IS_PED_SITTING_IN_ANY_VEHICLE(Any p0) { return invoke<BOOL>(0x0EA9CA03, p0); } // 0x0EA9CA03
    static BOOL IS_PED_ON_FOOT(Any p0) { return invoke<BOOL>(0xC60D0785, p0); } // 0xC60D0785
    ...
    static int GET_PED_ARMOUR(Ped p) { return invoke<int>(0x2CE311A7, p); } // 0x2CE311A7
    ...
    static Any _0xCD71F11B(Any p0) { return invoke<Any>(0xCD71F11B, p0); } // 0xCD71F11B
    static BOOL IS_PED_FALLING(Any p0) { return invoke<BOOL>(0xABF77334, p0); } // 0xABF77334
    static BOOL IS_PED_JUMPING(Any p0) { return invoke<BOOL>(0x07E5BC0E, p0); } // 0x07E5BC0E
    static BOOL IS_PED_CLIMBING(Any p0) { return invoke<BOOL>(0xBCE03D35, p0); } // 0xBCE03D35
    ...
    static Any CREATE_GROUP(Any p0) { return invoke<Any>(0x8DC0368D, p0); } // 0x8DC0368D
    static void SET_PED_AS_GROUP_LEADER(Any p0, Any p1) { invoke<Void>(0x7265BEA2, p0, p1); } // 0x7265BEA2
    static void SET_PED_AS_GROUP_MEMBER(Any p0, Any p1) { invoke<Void>(0x0EE13F92, p0, p1); } // 0x0EE13F92
    static void _0xD0D8BDBC(Any p0, Any p1, Any p2) { invoke<Void>(0xD0D8BDBC, p0, p1, p2); } // 0xD0D8BDBC
    static void REMOVE_GROUP(Any p0) { invoke<Void>(0x48D72B88, p0); } // 0x48D72B88
    static void REMOVE_PED_FROM_GROUP(Any p0) { invoke<Void>(0x82697713, p0); } // 0x82697713
    static BOOL IS_PED_GROUP_MEMBER(Any p0, Any p1) { return invoke<BOOL>(0x876D5363, p0, p1); } // 0x876D5363
    ...
    static void SET_PED_RELATIONSHIP_GROUP_HASH(Any p0, Any p1) { invoke<Void>(0x79F8C18C, p0, p1); } // 0x79F8C18C
    static void SET_RELATIONSHIP_BETWEEN_GROUPS(Any p0, Any p1, Any p2) { invoke<Void>(0xD4A215BA, p0, p1, p2); } // 0xD4A215BA
    static void CLEAR_RELATIONSHIP_BETWEEN_GROUPS(Any p0, Any p1, Any p2) { invoke<Void>(0x994B8C2D, p0, p1, p2); } // 0x994B8C2D
    static Any ADD_RELATIONSHIP_GROUP(Any p0, Any p1) { return invoke<Any>(0x8B635546, p0, p1); } // 0x8B635546
    static void REMOVE_RELATIONSHIP_GROUP(Any p0) { invoke<Void>(0x4A1DC59A, p0); } // 0x4A1DC59A
    static Any GET_RELATIONSHIP_BETWEEN_PEDS(Any p0, Any p1) { return invoke<Any>(0xE254C39C, p0, p1); } // 0xE254C39C
    static Any GET_PED_RELATIONSHIP_GROUP_DEFAULT_HASH(Any p0) { return invoke<Any>(0x714BD6E4, p0); } // 0x714BD6E4
    static Any GET_PED_RELATIONSHIP_GROUP_HASH(Any p0) { return invoke<Any>(0x354F283C, p0); } // 0x354F283C
    static Any GET_RELATIONSHIP_BETWEEN_GROUPS(Any p0, Any p1) { return invoke<Any>(0x4E372FE2, p0, p1); } // 0x4E372FE2
    ...
    static void SET_PED_FIRING_PATTERN(Any p0, Any p1) { invoke<Void>(0xB4629D66, p0, p1); } // 0xB4629D66
    static void SET_PED_SHOOT_RATE(Any p0, Any p1) { invoke<Void>(0xFB301746, p0, p1); } // 0xFB301746
    ...
    static BOOL DOES_GROUP_EXIST(Any p0) { return invoke<BOOL>(0x935C978D, p0); } // 0x935C978D
    static Any GET_PED_GROUP_INDEX(Any p0) { return invoke<Any>(0x134E0785, p0); } // 0x134E0785
    static BOOL IS_PED_IN_GROUP(Any p0) { return invoke<BOOL>(0x836D9795, p0); } // 0x836D9795
    static Any _0xDE7442EE(Any p0) { return invoke<Any>(0xDE7442EE, p0); } // 0xDE7442EE
    static void SET_GROUP_FORMATION(Any p0, Any p1) { invoke<Void>(0x08FAC739, p0, p1); } // 0x08FAC739
    ...
    static Vehicle GET_VEHICLE_PED_IS_USING(Ped p) { return invoke<Any>(0x6DE3AADA, p); } // 0x6DE3AADA
    static Any SET_EXCLUSIVE_PHONE_RELATIONSHIPS(Any p0) { return invoke<Any>(0x56E0C163, p0); } // 0x56E0C163
    static void SET_PED_GRAVITY(Ped p, BOOL gravity) { invoke<Void>(0x3CA16652, p, gravity); } // 0x3CA16652
    static void APPLY_DAMAGE_TO_PED(Any p0, Any p1, Any p2) { invoke<Void>(0x4DC27FCF, p0, p1, p2); } // 0x4DC27FCF
    static void SET_PED_ALLOWED_TO_DUCK(Any p0, Any p1) { invoke<Void>(0xC4D122F8, p0, p1); } // 0xC4D122F8
    static void SET_PED_NEVER_LEAVES_GROUP(Any p0, Any p1) { invoke<Void>(0x0E038813, p0, p1); } // 0x0E038813
    static Any GET_PED_TYPE(Any p0) { return invoke<Any>(0xB1460D43, p0); } // 0xB1460D43
    static void SET_PED_AS_COP(Any p0, Any p1) { invoke<Void>(0x84E7DE9F, p0, p1); } // 0x84E7DE9F
    ...
    static void SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(Any p0, Any p1) { invoke<Void>(0x8A251612, p0, p1); } // 0x8A251612
    static Any _0xC9D098B3(Any p0) { return invoke<Any>(0xC9D098B3, p0); } // 0xC9D098B3
    static void KNOCK_PED_OFF_VEHICLE(Any p0) { invoke<Void>(0xACDD0674, p0); } // 0xACDD0674
    static void SET_PED_COORDS_NO_GANG(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x9561AD98, p0, p1, p2, p3); } // 0x9561AD98
    static Any GET_PED_AS_GROUP_MEMBER(Any p0, Any p1) { return invoke<Any>(0x9AA3CC8C, p0, p1); } // 0x9AA3CC8C
    static void SET_PED_KEEP_TASK(Any p0, Any p1) { invoke<Void>(0xA7EC79CE, p0, p1); } // 0xA7EC79CE
    ...
    static void SET_PED_COORDS_KEEP_VEHICLE(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xD66AE1D3, p0, p1, p2, p3); } // 0xD66AE1D3
    static void SET_PED_DIES_IN_VEHICLE(Any p0, Any p1) { invoke<Void>(0x6FE1E440, p0, p1); } // 0x6FE1E440
    static void SET_CREATE_RANDOM_COPS(BOOL b) { invoke<Void>(0x23441648, b); } // 0x23441648
    ...
    static void SET_PED_AS_ENEMY(Any p0, Any p1) { invoke<Void>(0xAE620A1B, p0, p1); } // 0xAE620A1B
    static void SET_PED_CAN_SMASH_GLASS(Any p0, Any p1, Any p2) { invoke<Void>(0x149C60A8, p0, p1, p2); } // 0x149C60A8
    static BOOL IS_PED_IN_ANY_TRAIN(Ped p) { return invoke<BOOL>(0x759EF63A, p); } // 0x759EF63A
    static BOOL IS_PED_GETTING_INTO_A_VEHICLE(Ped p) { return invoke<BOOL>(0x90E805AC, p); } // 0x90E805AC
    static BOOL IS_PED_TRYING_TO_ENTER_A_LOCKED_VEHICLE(Ped p) { return invoke<BOOL>(0x46828B4E, p); } // 0x46828B4E
    static void SET_ENABLE_HANDCUFFS(Any p0, Any p1) { invoke<Void>(0xAC9BBA23, p0, p1); } // 0xAC9BBA23
    ...
    static void SET_CAN_ATTACK_FRIENDLY(Any p0, Any p1, Any p2) { invoke<Void>(0x47C60963, p0, p1, p2); } // 0x47C60963
    ...
    static Any GET_PED_DRAWABLE_VARIATION(Any p0, Any p1) { return invoke<Any>(0x29850FE2, p0, p1); } // 0x29850FE2
    static Any GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(Any p0, Any p1) { return invoke<Any>(0x9754C27D, p0, p1); } // 0x9754C27D
    static Any GET_PED_TEXTURE_VARIATION(Any p0, Any p1) { return invoke<Any>(0xC0A8590A, p0, p1); } // 0xC0A8590A
    static Any GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(Any p0, Any p1, Any p2) { return invoke<Any>(0x83D9FBE7, p0, p1, p2); } // 0x83D9FBE7
    static Any _0xC9780B95(Any p0, Any p1) { return invoke<Any>(0xC9780B95, p0, p1); } // 0xC9780B95
    static Any REMOVE_NIGHTVISION_MELEE(Any p0, Any p1, Any p2) { return invoke<Any>(0x4892B882, p0, p1, p2); } // 0x4892B882
    static Any GET_PED_PALETTE_VARIATION(Any p0, Any p1) { return invoke<Any>(0xEF1BC082, p0, p1); } // 0xEF1BC082
    ...
    static void SET_PED_RANDOM_COMPONENT_VARIATION(Ped ped, BOOL rand) { invoke<Void>(0x4111BA46, ped, rand); } // 0x4111BA46
    static void SET_PED_RANDOM_PROPS(Any p0) { invoke<Void>(0xE3318E0E, p0); } // 0xE3318E0E
    static void SET_PED_DEFAULT_COMPONENT_VARIATION(Ped p) { invoke<Void>(0xC866A984, p); } // 0xC866A984
    ...
    static Any GET_PED_PROP_INDEX(Any p0, Any p1) { return invoke<Any>(0x746DDAC0, p0, p1); } // 0x746DDAC0
    static void SET_PED_PROP_INDEX(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x0829F2E2, p0, p1, p2, p3, p4); } // 0x0829F2E2
    static void KNOCK_OFF_PED_PROP(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x08D8B180, p0, p1, p2, p3, p4); } // 0x08D8B180
    static void CLEAR_PED_PROP(Any p0, Any p1) { invoke<Void>(0x2D23D743, p0, p1); } // 0x2D23D743
    static void CLEAR_ALL_PED_PROPS(Any p0) { invoke<Void>(0x81DF8B43, p0); } // 0x81DF8B43
    ...
    static void REGISTER_HATED_TARGETS_AROUND_PED(Any p0, Any p1) { invoke<Void>(0x7F87559E, p0, p1); } // 0x7F87559E
    static Any GET_RANDOM_PED_AT_COORD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { return invoke<Any>(0xDC8239EB, p0, p1, p2, p3, p4, p5, p6); } // 0xDC8239EB
    static Any GET_CLOSEST_PED(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9) { return invoke<Any>(0x8F6C1F55, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); } // 0x8F6C1F55
    ...
    static Any SET_PED_TO_RAGDOLL(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { return invoke<Any>(0x83CB5052, p0, p1, p2, p3, p4, p5, p6); } // 0x83CB5052
    ...
    static void SET_PED_RAGDOLL_ON_COLLISION(Any p0, Any p1) { invoke<Void>(0x2654A0F4, p0, p1); } // 0x2654A0F4
    ...
    static void SET_PED_RAGDOLL_FORCE_FALL(Any p0) { invoke<Void>(0x20A5BDE0, p0); } // 0x20A5BDE0
    static void RESET_PED_RAGDOLL_TIMER(Any p0) { invoke<Void>(0xF2865370, p0); } // 0xF2865370
    static void SET_PED_CAN_RAGDOLL(Ped ped, BOOL b) { invoke<Void>(0xCF1384C4, ped, b); } // 0xCF1384C4
    ...
    static void SET_PED_DIES_WHEN_INJURED(Any p0, Any p1) { invoke<Void>(0xE94E24D4, p0, p1); } // 0xE94E24D4
    static void SET_PED_ENABLE_WEAPON_BLOCKING(Any p0, Any p1) { invoke<Void>(0x4CAD1A4A, p0, p1); } // 0x4CAD1A4A
    static void _0x141CC936(Any p0, Any p1) { invoke<Void>(0x141CC936, p0, p1); } // 0x141CC936
    static void RESET_PED_VISIBLE_DAMAGE(Any p0) { invoke<Void>(0xC4BC4841, p0); } // 0xC4BC4841
    static void _0x1E54DB12(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x1E54DB12, p0, p1, p2, p3, p4); } // 0x1E54DB12
    static void APPLY_PED_BLOOD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x376CE3C0, p0, p1, p2, p3, p4, p5); } // 0x376CE3C0
    ...
    static void APPLY_PED_DAMAGE_DECAL(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9) { invoke<Void>(0x8A13A41F, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); } // 0x8A13A41F
    static void APPLY_PED_DAMAGE_PACK(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x208D0CB8, p0, p1, p2, p3); } // 0x208D0CB8
    static void CLEAR_PED_BLOOD_DAMAGE(Any p0) { invoke<Void>(0xF7ADC960, p0); } // 0xF7ADC960
    static void _0xF210BE69(Any p0, Any p1) { invoke<Void>(0xF210BE69, p0, p1); } // 0xF210BE69
    ...
    static void CLEAR_PED_WETNESS(Any p0) { invoke<Void>(0x629F15BD, p0); } // 0x629F15BD
    static void SET_PED_WETNESS_HEIGHT(Any p0, Any p1) { invoke<Void>(0x7B33289A, p0, p1); } // 0x7B33289A
    static void SET_PED_WETNESS_ENABLED_THIS_FRAME(Any p0) { invoke<Void>(0xBDE749F7, p0); } // 0xBDE749F7
    static void _0xA993915F(Any p0) { invoke<Void>(0xA993915F, p0); } // 0xA993915F
    static void SET_PED_SWEAT(Any p0, Any p1) { invoke<Void>(0x76A1DB9F, p0, p1); } // 0x76A1DB9F
    static void _0x70559AC7(Any p0, Any p1, Any p2) { invoke<Void>(0x70559AC7, p0, p1, p2); } // 0x70559AC7
    static Any _0x3543019E(Any p0, Any p1) { return invoke<Any>(0x3543019E, p0, p1); } // 0x3543019E
    static void CLEAR_PED_DECORATIONS(Any p0) { invoke<Void>(0xD4496BF3, p0); } // 0xD4496BF3
    ...
    static Vector3 GET_PED_BONE_COORDS(Any p0, Any p1, Any p2, Any p3, Any p4) { return invoke<Vector3>(0x4579CAB1, p0, p1, p2, p3, p4); } // 0x4579CAB1
    ...
    static void SET_PED_GENERATES_DEAD_BODY_EVENTS(Any p0, Any p1) { invoke<Void>(0xE9B97A2B, p0, p1); } // 0xE9B97A2B
    ...
    static BOOL IS_PED_WEARING_HELMET(Any p0) { return invoke<BOOL>(0x0D680D49, p0); } // 0x0D680D49
    ...
    static void SET_PED_CAN_PEEK_IN_COVER(Any p0, Any p1) { invoke<Void>(0xC1DAE216, p0, p1); } // 0xC1DAE216
    ...
    static void SET_PED_CAN_SWITCH_WEAPON(Any p0, Any p1) { invoke<Void>(0xB5F8BA28, p0, p1); } // 0xB5F8BA28
    static void SET_PED_DIES_INSTANTLY_IN_WATER(Any p0, Any p1) { invoke<Void>(0xFE2554FC, p0, p1); } // 0xFE2554FC
    ...
    static void SET_PED_COMBAT_ABILITY(Any p0, Any p1) { invoke<Void>(0x6C23D329, p0, p1); } // 0x6C23D329
    static void SET_PED_COMBAT_RANGE(Any p0, Any p1) { invoke<Void>(0x8818A959, p0, p1); } // 0x8818A959
    ...
    static Any _0x9BE7C860(Any p0) { return invoke<Any>(0x9BE7C860, p0); } // 0x9BE7C860
    ...
    static void SET_PED_STEERS_AROUND_PEDS(Any p0, Any p1) { invoke<Void>(0x797CAE4F, p0, p1); } // 0x797CAE4F
    static void SET_PED_STEERS_AROUND_OBJECTS(Any p0, Any p1) { invoke<Void>(0x3BD9B0A6, p0, p1); } // 0x3BD9B0A6
    static void SET_PED_STEERS_AROUND_VEHICLES(Any p0, Any p1) { invoke<Void>(0x533C0651, p0, p1); } // 0x533C0651
    ...
    static Any GET_PED_BONE_INDEX(Any p0, Any p1) { return invoke<Any>(0x259C6BA2, p0, p1); } // 0x259C6BA2
    ...
    static Any GET_PED_NEARBY_VEHICLES(Any p0, Any p1) { return invoke<Any>(0xCB716F68, p0, p1); } // 0xCB716F68
    static Any GET_PED_NEARBY_PEDS(Any p0, Any p1, Any p2) { return invoke<Any>(0x4D3325F4, p0, p1, p2); } // 0x4D3325F4
...
namespace VEHICLE
{
    static Vehicle CREATE_VEHICLE(Hash model, float x, float y, float z, float r, BOOL b1, BOOL b2) { return invoke<Vehicle>(0xDD75460A, model, x, y, z, r, b1, b2); } // 0xDD75460A
    static void DELETE_VEHICLE(Vehicle *v) { invoke<Void>(0x9803AF60, v); } // 0x9803AF60
    static void _0x8BAAC437(Any p0, Any p1) { invoke<Void>(0x8BAAC437, p0, p1); } // 0x8BAAC437
    static Any _0xFBDE9FD8(Any p0) { return invoke<Any>(0xFBDE9FD8, p0); } // 0xFBDE9FD8
    static BOOL IS_VEHICLE_MODEL(Any p0, Any p1) { return invoke<BOOL>(0x013B10B6, p0, p1); } // 0x013B10B6
    ...
    static BOOL SET_VEHICLE_ON_GROUND_PROPERLY(Vehicle v) { return invoke<BOOL>(0xE14FDBA6, v); } // 0xE14FDBA6
    static Any SET_ALL_VEHICLES_SPAWN(Any p0, Any p1, Any p2, Any p3) { return invoke<Any>(0xA0909ADB, p0, p1, p2, p3); } // 0xA0909ADB
    static BOOL IS_VEHICLE_STUCK_ON_ROOF(Any p0) { return invoke<BOOL>(0x18D07C6C, p0); } // 0x18D07C6C
    ...
    static Any GET_VEHICLE_NUMBER_OF_PASSENGERS(Any p0) { return invoke<Any>(0x1EF20849, p0); } // 0x1EF20849
    static Any GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(Any p0) { return invoke<Any>(0x0A2FC08C, p0); } // 0x0A2FC08C
    static Any _0x838F7BF7(Any p0) { return invoke<Any>(0x838F7BF7, p0); } // 0x838F7BF7
    static Any _0x769E5CF2(Any p0, Any p1) { return invoke<Any>(0x769E5CF2, p0, p1); } // 0x769E5CF2
    ...
    static void SET_NUMBER_OF_PARKED_VEHICLES(Any p0) { invoke<Void>(0x206A58E8, p0); } // 0x206A58E8
    static void SET_VEHICLE_DOORS_LOCKED(Any p0, Any p1) { invoke<Void>(0x4CDD35D0, p0, p1); } // 0x4CDD35D0
    ...
    static void EXPLODE_VEHICLE(Any p0, Any p1, Any p2) { invoke<Void>(0xBEDEACEB, p0, p1, p2); } // 0xBEDEACEB
    ...
    static void SET_TAXI_LIGHTS(Any p0, Any p1) { invoke<Void>(0x68639D85, p0, p1); } // 0x68639D85
    static BOOL IS_TAXI_LIGHT_ON(Any p0) { return invoke<BOOL>(0x6FC4924A, p0); } // 0x6FC4924A
    ...
    static void SET_VEHICLE_FULLBEAM(Any p0, Any p1) { invoke<Void>(0x9C49CC15, p0, p1); } // 0x9C49CC15
    static void STEER_UNLOCK_BIAS(Any p0, Any p1) { invoke<Void>(0xA59E3DCD, p0, p1); } // 0xA59E3DCD
    static void SET_VEHICLE_CUSTOM_PRIMARY_COLOUR(Vehicle veh, int r, int g, int b) { invoke<Void>(0x8DF9F9BC, veh, r, g, b); } // 0x8DF9F9BC
    static void GET_VEHICLE_CUSTOM_PRIMARY_COLOUR(Vehicle veh, int *r, int *g, int *b) { invoke<Void>(0x1C2B9FEF, veh, r, g, b); } // 0x1C2B9FEF
    static void CLEAR_VEHICLE_CUSTOM_PRIMARY_COLOUR(Vehicle veh) { invoke<Void>(0x51E1E33D, veh); } // 0x51E1E33D
    static Any _0xD7EC8760(Any p0) { return invoke<Any>(0xD7EC8760, p0); } // 0xD7EC8760
    static void SET_VEHICLE_CUSTOM_SECONDARY_COLOUR(Vehicle veh, int r, int g, int b) { invoke<Void>(0x9D77259E, veh, r, g, b); } // 0x9D77259E
    static void GET_VEHICLE_CUSTOM_SECONDARY_COLOUR(Vehicle veh, int *r, int *g, int *b) { invoke<Void>(0x3FF247A2, veh, r, g, b); } // 0x3FF247A2
    static void CLEAR_VEHICLE_CUSTOM_SECONDARY_COLOUR(Vehicle veh) { invoke<Void>(0x7CE00B29, veh); } // 0x7CE00B29
    static Any _0x288AD228(Any p0) { return invoke<Any>(0x288AD228, p0); } // 0x288AD228
    static void SET_CAN_RESPRAY_VEHICLE(Any p0, Any p1) { invoke<Void>(0x37677590, p0, p1); } // 0x37677590
    static void _0x54E9EE75(Any p0, Any p1) { invoke<Void>(0x54E9EE75, p0, p1); } // 0x54E9EE75
    static void _0x4A46E814(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x4A46E814, p0, p1, p2, p3, p4); } // 0x4A46E814
    static void SET_BOAT_ANCHOR(Any p0, Any p1) { invoke<Void>(0xA3906284, p0, p1); } // 0xA3906284
    ...
    static void SET_VEHICLE_SIREN(Any p0, Any p1) { invoke<Void>(0x4AC1EFC7, p0, p1); } // 0x4AC1EFC7
    static BOOL IS_VEHICLE_SIREN_ON(Any p0) { return invoke<BOOL>(0x25EB5873, p0); } // 0x25EB5873
    static void SET_VEHICLE_STRONG(Any p0, Any p1) { invoke<Void>(0xC758D19F, p0, p1); } // 0xC758D19F
    static void REMOVE_VEHICLE_STUCK_CHECK(Any p0) { invoke<Void>(0x81594917, p0); } // 0x81594917
    static void GET_VEHICLE_COLOURS(Any p0, Any p1, Any p2) { invoke<Void>(0x40D82D88, p0, p1, p2); } // 0x40D82D88
    static BOOL IS_VEHICLE_SEAT_FREE(Any p0, Any p1) { return invoke<BOOL>(0xDAF42B02, p0, p1); } // 0xDAF42B02
    static Any GET_PED_IN_VEHICLE_SEAT(Any p0, Any p1) { return invoke<Any>(0x388FDE9A, p0, p1); } // 0x388FDE9A
    ...
    static BOOL IS_VEHICLE_TYRE_BURST(Any p0, Any p1, Any p2) { return invoke<BOOL>(0x48C80210, p0, p1, p2); } // 0x48C80210
    static void SET_VEHICLE_FORWARD_SPEED(Vehicle veh, float speed) { invoke<Void>(0x69880D14, veh, speed); } // 0x69880D14
    ...
    static void SET_VEHICLE_DOORS_SHUT(Any p0, Any p1) { invoke<Void>(0xBB1FF6E7, p0, p1); } // 0xBB1FF6E7
    static void SET_VEHICLE_TYRES_CAN_BURST(Vehicle veh, BOOL b) { invoke<Void>(0xA198DB54, veh, b); } // 0xA198DB54
    static Any GET_VEHICLE_TYRES_CAN_BURST(Any p0) { return invoke<Any>(0x4D76CD2F, p0); } // 0x4D76CD2F
    static void SET_VEHICLE_WHEELS_CAN_BREAK(Vehicle veh, BOOL b) { invoke<Void>(0x829ED654, veh, b); } // 0x829ED654
    static void SET_VEHICLE_DOOR_OPEN(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xBB75D38B, p0, p1, p2, p3); } // 0xBB75D38B
    static void REMOVE_VEHICLE_WINDOW(Any p0, Any p1) { invoke<Void>(0xBB8104A3, p0, p1); } // 0xBB8104A3
    static void ROLL_DOWN_WINDOWS(Any p0) { invoke<Void>(0x51A16DC6, p0); } // 0x51A16DC6
    static void ROLL_DOWN_WINDOW(Any p0, Any p1) { invoke<Void>(0xF840134C, p0, p1); } // 0xF840134C
    static void ROLL_UP_WINDOW(Any p0, Any p1) { invoke<Void>(0x83B7E06A, p0, p1); } // 0x83B7E06A
    static void SMASH_VEHICLE_WINDOW(Any p0, Any p1) { invoke<Void>(0xDDD9A8C2, p0, p1); } // 0xDDD9A8C2
    static void FIX_VEHICLE_WINDOW(Any p0, Any p1) { invoke<Void>(0x6B8E990D, p0, p1); } // 0x6B8E990D
    static void _0xCC95C96B(Any p0) { invoke<Void>(0xCC95C96B, p0); } // 0xCC95C96B
    ...
    static void SET_VEHICLE_ALARM(Any p0, Any p1) { invoke<Void>(0x24877D84, p0, p1); } // 0x24877D84
    static void START_VEHICLE_ALARM(Any p0) { invoke<Void>(0x5B451FF7, p0); } // 0x5B451FF7
    static BOOL IS_VEHICLE_ALARM_ACTIVATED(Any p0) { return invoke<BOOL>(0xF2630A4C, p0); } // 0xF2630A4C
    static void SET_VEHICLE_INTERIORLIGHT(Any p0, Any p1) { invoke<Void>(0x9AD1FE1E, p0, p1); } // 0x9AD1FE1E
    static void SET_VEHICLE_LIGHT_MULTIPLIER(Any p0, Any p1) { invoke<Void>(0x48039D6A, p0, p1); } // 0x48039D6A
    ...
    static BOOL IS_VEHICLE_ATTACHED_TO_TRAILER(Any p0) { return invoke<BOOL>(0xE142BBCC, p0); } // 0xE142BBCC
    ...
    static void SET_VEHICLE_TYRE_FIXED(Any p0, Any p1) { invoke<Void>(0xA42EFA6B, p0, p1); } // 0xA42EFA6B
    static void SET_VEHICLE_NUMBER_PLATE_TEXT(Any p0, Any p1) { invoke<Void>(0x400F9556, p0, p1); } // 0x400F9556
    static Any GET_VEHICLE_NUMBER_PLATE_TEXT(Any p0) { return invoke<Any>(0xE8522D58, p0); } // 0xE8522D58
    static Any GET_NUMBER_OF_VEHICLE_NUMBER_PLATES() { return invoke<Any>(0xD24BC1AE); } // 0xD24BC1AE
    static void SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(Vehicle veh, int index) { invoke<Void>(0xA1A1890E, veh, index); } // 0xA1A1890E
    static int GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(Vehicle veh) { return invoke<int>(0x499747B6, veh); } // 0x499747B6
    static void SET_RANDOM_TRAINS(BOOL b) { invoke<Void>(0xD461CA7F, b); } // 0xD461CA7F
    ...
    static void SET_RANDOM_BOATS(BOOL b) { invoke<Void>(0xB505BD89, b); } // 0xB505BD89
    static void SET_GARBAGE_TRUCKS(BOOL b) { invoke<Void>(0xD9ABB0FF, b); } // 0xD9ABB0FF
    ...
    static void SET_PLAYBACK_SPEED(Any p0, Any p1) { invoke<Void>(0x684E26E4, p0, p1); } // 0x684E26E4
    ...
    static Any GET_RANDOM_VEHICLE_IN_SPHERE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { return invoke<Any>(0x57216D03, p0, p1, p2, p3, p4, p5); } // 0x57216D03
    static Any GET_RANDOM_VEHICLE_FRONT_BUMPER_IN_SPHERE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { return invoke<Any>(0xDCADEB66, p0, p1, p2, p3, p4, p5, p6); } // 0xDCADEB66
    static Any GET_RANDOM_VEHICLE_BACK_BUMPER_IN_SPHERE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { return invoke<Any>(0xD6343F6B, p0, p1, p2, p3, p4, p5, p6); } // 0xD6343F6B
    static Any GET_CLOSEST_VEHICLE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { return invoke<Any>(0xD7E26B2C, p0, p1, p2, p3, p4, p5); } // 0xD7E26B2C
    ...
    static void SET_HELI_BLADES_SPEED(Any p0, Any p1) { invoke<Void>(0x5C7D4EA9, p0, p1); } // 0x5C7D4EA9
    static void _0x1128A45B(Any p0, Any p1, Any p2) { invoke<Void>(0x1128A45B, p0, p1, p2); } // 0x1128A45B
    static void SET_VEHICLE_CAN_BE_TARGETTED(Any p0, Any p1) { invoke<Void>(0x64B70B1D, p0, p1); } // 0x64B70B1D
    static void _0x486C1280(Any p0, Any p1) { invoke<Void>(0x486C1280, p0, p1); } // 0x486C1280
    static void SET_VEHICLE_CAN_BE_VISIBLY_DAMAGED(Vehicle veh, BOOL b) { invoke<Void>(0xC5D94017, veh, b); } // 0xC5D94017
    ...
    static Any GET_VEHICLE_DIRT_LEVEL(Any p0) { return invoke<Any>(0xFD15C065, p0); } // 0xFD15C065
    static void SET_VEHICLE_DIRT_LEVEL(Any p0, Any p1) { invoke<Void>(0x2B39128B, p0, p1); } // 0x2B39128B
    static Any _0xDAC523BC(Any p0) { return invoke<Any>(0xDAC523BC, p0); } // 0xDAC523BC
    static BOOL IS_VEHICLE_DOOR_FULLY_OPEN(Any p0, Any p1) { return invoke<BOOL>(0xC2385B6F, p0, p1); } // 0xC2385B6F
    static void SET_VEHICLE_ENGINE_ON(Any p0, Any p1, Any p2) { invoke<Void>(0x7FBC86F1, p0, p1, p2); } // 0x7FBC86F1
    static void SET_VEHICLE_UNDRIVEABLE(Any p0, Any p1) { invoke<Void>(0x48D02A4E, p0, p1); } // 0x48D02A4E
    ...
    static void SET_VEHICLE_DOOR_SHUT(Any p0, Any p1, Any p2) { invoke<Void>(0x142606BD, p0, p1, p2); } // 0x142606BD
    static void SET_VEHICLE_DOOR_BROKEN(Any p0, Any p1, Any p2) { invoke<Void>(0x8147FEA7, p0, p1, p2); } // 0x8147FEA7
    static void SET_VEHICLE_CAN_BREAK(Vehicle veh, BOOL b) { invoke<Void>(0x90A810D1, veh, b); } // 0x90A810D1
    static BOOL DOES_VEHICLE_HAVE_ROOF(Any p0) { return invoke<BOOL>(0xDB817403, p0); } // 0xDB817403
    static BOOL IS_BIG_VEHICLE(Any p0) { return invoke<BOOL>(0x9CDBA8DE, p0); } // 0x9CDBA8DE
    static Any GET_NUMBER_OF_VEHICLE_MODEL_COLOURS(Any p0) { return invoke<Any>(0x8CC23EEC, p0); } // 0x8CC23EEC
    ...
    static void GET_RANDOM_VEHICLE_MODEL_IN_MEMORY(Any p0, Any p1, Any p2) { invoke<Void>(0xE2C45631, p0, p1, p2); } // 0xE2C45631
    static Any GET_VEHICLE_DOOR_LOCK_STATUS(Any p0) { return invoke<Any>(0x0D72CEF2, p0); } // 0x0D72CEF2
    static BOOL IS_VEHICLE_DOOR_DAMAGED(Any p0, Any p1) { return invoke<BOOL>(0x4999E3C3, p0, p1); } // 0x4999E3C3
    ...
    static BOOL IS_COP_VEHICLE_IN_AREA_3D(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { return invoke<BOOL>(0xFB16C6D1, p0, p1, p2, p3, p4, p5); } // 0xFB16C6D1
    static BOOL IS_VEHICLE_ON_ALL_WHEELS(Any p0) { return invoke<BOOL>(0x10089F8E, p0); } // 0x10089F8E
    static Any GET_VEHICLE_MODEL_VALUE(Any p0) { return invoke<Any>(0x58FEFC3D, p0); } // 0x58FEFC3D
    ...
    static void SET_VEHICLE_FIXED(Vehicle veh) { invoke<Void>(0x17469AA1, veh); } // 0x17469AA1
    static void SET_VEHICLE_DEFORMATION_FIXED(Vehicle veh) { invoke<Void>(0xDD2920C8, veh); } // 0xDD2920C8
    ...
    static void _0xAD3E05F2(Any p0, Any p1) { invoke<Void>(0xAD3E05F2, p0, p1); } // 0xAD3E05F2
    ...
    static void REMOVE_VEHICLES_FROM_GENERATORS_IN_AREA(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x42CC15E0, p0, p1, p2, p3, p4, p5); } // 0x42CC15E0
    ...
    static void SET_VEHICLE_EXTRA(Any p0, Any p1, Any p2) { invoke<Void>(0x642D065C, p0, p1, p2); } // 0x642D065C
    ...
    static Any GET_VEHICLE_ENGINE_HEALTH(Any p0) { return invoke<Any>(0x8880038A, p0); } // 0x8880038A
    static void SET_VEHICLE_ENGINE_HEALTH(Any p0, Any p1) { invoke<Void>(0x1B760FB5, p0, p1); } // 0x1B760FB5
    static Any GET_VEHICLE_PETROL_TANK_HEALTH(Any p0) { return invoke<Any>(0xE41595CE, p0); } // 0xE41595CE
    static void SET_VEHICLE_PETROL_TANK_HEALTH(Any p0, Any p1) { invoke<Void>(0x660A3692, p0, p1); } // 0x660A3692
    ...
    static void START_VEHICLE_HORN(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x0DF5ADB3, p0, p1, p2, p3); } // 0x0DF5ADB3
    ...
    static void SET_VEHICLE_LIVERY(Any p0, Any p1) { invoke<Void>(0x7AD87059, p0, p1); } // 0x7AD87059
    ...
    static void _0x95A9ACCB(Any p0, Any p1) { invoke<Void>(0x95A9ACCB, p0, p1); } // 0x95A9ACCB
    ...
    static BOOL IS_ANY_VEHICLE_NEAR_POINT(Any p0, Any p1, Any p2, Any p3) { return invoke<BOOL>(0x2867A834, p0, p1, p2, p3); } // 0x2867A834
    ...
    static void REQUEST_VEHICLE_ASSET(Any p0, Any p1) { invoke<Void>(0x902B4F06, p0, p1); } // 0x902B4F06
    ...
    static void ATTACH_VEHICLE_TO_TOW_TRUCK(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x8151571A, p0, p1, p2, p3, p4, p5); } // 0x8151571A
    ...
    static BOOL IS_VEHICLE_IN_BURNOUT(Any p0) { return invoke<BOOL>(0x6632BC12, p0); } // 0x6632BC12
    static void SET_VEHICLE_REDUCE_GRIP(Any p0, Any p1) { invoke<Void>(0x90D3A0D9, p0, p1); } // 0x90D3A0D9
    static void SET_VEHICLE_INDICATOR_LIGHTS(Any p0, Any p1, Any p2) { invoke<Void>(0xA6073B5D, p0, p1, p2); } // 0xA6073B5D
    static void SET_VEHICLE_BRAKE_LIGHTS(Any p0, Any p1) { invoke<Void>(0x6D9BA11E, p0, p1); } // 0x6D9BA11E
    static void SET_VEHICLE_HANDBRAKE(Any p0, Any p1) { invoke<Void>(0xBA729A25, p0, p1); } // 0xBA729A25
    ...
    static BOOL IS_VEHICLE_SEARCHLIGHT_ON(Any p0) { return invoke<BOOL>(0xADAF3513, p0); } // 0xADAF3513
    ...
    static Any _0xB3EB01ED(Any p0, Any p1) { return invoke<Any>(0xB3EB01ED, p0, p1); } // 0xB3EB01ED
    static Any GET_NUM_MOD_KITS(Any p0) { return invoke<Any>(0xE4903AA0, p0); } // 0xE4903AA0
    static void SET_VEHICLE_MOD_KIT(Any p0, Any p1) { invoke<Void>(0xB8132158, p0, p1); } // 0xB8132158
    ...
    static Any GET_VEHICLE_WHEEL_TYPE(Any p0) { return invoke<Any>(0xDA58D7AE, p0); } // 0xDA58D7AE
    static void SET_VEHICLE_WHEEL_TYPE(Any p0, Any p1) { invoke<Void>(0x64BDAAAD, p0, p1); } // 0x64BDAAAD
    static Any _0x73722CD9(Any p0, Any p1) { return invoke<Any>(0x73722CD9, p0, p1); } // 0x73722CD9
    static void SET_VEHICLE_MOD_COLOR_1(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xCBE9A54D, p0, p1, p2, p3); } // 0xCBE9A54D
    ...
    static void SET_VEHICLE_MOD(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xB52E5ED5, p0, p1, p2, p3); } // 0xB52E5ED5
    static Any GET_VEHICLE_MOD(Any p0, Any p1) { return invoke<Any>(0xDC520069, p0, p1); } // 0xDC520069
    static Any GET_VEHICLE_MOD_VARIATION(Any p0, Any p1) { return invoke<Any>(0xC1B92003, p0, p1); } // 0xC1B92003
    static Any GET_NUM_VEHICLE_MODS(Any p0, Any p1) { return invoke<Any>(0x8A814FF9, p0, p1); } // 0x8A814FF9
    static void REMOVE_VEHICLE_MOD(Any p0, Any p1) { invoke<Void>(0x9CC80A43, p0, p1); } // 0x9CC80A43
    static void TOGGLE_VEHICLE_MOD(Any p0, Any p1, Any p2) { invoke<Void>(0xD095F811, p0, p1, p2); } // 0xD095F811
    static BOOL IS_TOGGLE_MOD_ON(Any p0, Any p1) { return invoke<BOOL>(0xF0E1689F, p0, p1); } // 0xF0E1689F
    static Any GET_MOD_TEXT_LABEL(Any p0, Any p1, Any p2) { return invoke<Any>(0x0BA39CA7, p0, p1, p2); } // 0x0BA39CA7
    static Any GET_MOD_SLOT_NAME(Any p0, Any p1) { return invoke<Any>(0x5E113483, p0, p1); } // 0x5E113483
    ...
    static void SET_VEHICLE_TYRE_SMOKE_COLOR(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x3EDEC0DB, p0, p1, p2, p3); } // 0x3EDEC0DB
    static void GET_VEHICLE_TYRE_SMOKE_COLOR(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x75280015, p0, p1, p2, p3); } // 0x75280015
    static void SET_VEHICLE_WINDOW_TINT(Any p0, Any p1) { invoke<Void>(0x497C8787, p0, p1); } // 0x497C8787
    static Any GET_VEHICLE_WINDOW_TINT(Any p0) { return invoke<Any>(0x13D53892, p0); } // 0x13D53892
    static Any _0x625C7B66() { return invoke<Any>(0x625C7B66); } // 0x625C7B66
    ...
    static void _0xE943B09C(Any p0, Any p1) { invoke<Void>(0xE943B09C, p0, p1); } // 0xE943B09C
    ...
    static void _0x642DA5AA(Any p0, Any p1) { invoke<Void>(0x642DA5AA, p0, p1); } // 0x642DA5AA
    static void _0x04F5546C(Any p0, Any p1) { invoke<Void>(0x04F5546C, p0, p1); } // 0x04F5546C
    static void SET_VEHICLE_IS_WANTED(Any p0, Any p1) { invoke<Void>(0xDAA388E8, p0, p1); } // 0xDAA388E8
    ...
    static Any GET_VEHICLE_PLATE_TYPE(Any p0) { return invoke<Any>(0x65CA9286, p0); } // 0x65CA9286
    ...
    static void SET_VEHICLE_GRAVITY(Vehicle veh, BOOL b) { invoke<Void>(0x07B2A6DC, veh, b); } // 0x07B2A6DC
    ...
    static void _0x081DAC12(Any p0, Any p1) { invoke<Void>(0x081DAC12, p0, p1); } // 0x081DAC12
    ...
    static BOOL IS_VEHICLE_STOLEN(Any p0) { return invoke<BOOL>(0x20B61DDE, p0); } // 0x20B61DDE
    static void SET_VEHICLE_IS_STOLEN(Any p0, Any p1) { invoke<Void>(0x70912E42, p0, p1); } // 0x70912E42
    ...
    static void ATTACH_VEHICLE_TO_CARGOBOB(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x607DC9D5, p0, p1, p2, p3, p4, p5); } // 0x607DC9D5
    ...
    static BOOL DOES_VEHICLE_HAVE_WEAPONS(Any p0) { return invoke<BOOL>(0xB2E1E1FB, p0); } // 0xB2E1E1FB
    ...
    static Any GET_VEHICLE_CLASS(Any p0) { return invoke<Any>(0xC025338E, p0); } // 0xC025338E
    static Any GET_VEHICLE_CLASS_FROM_NAME(Any p0) { return invoke<Any>(0xEA469980, p0); } // 0xEA469980
    static void SET_PLAYERS_LAST_VEHICLE(Any p0) { invoke<Void>(0xDE86447D, p0); } // 0xDE86447D
...
namespace OBJECT
{
    static Any CREATE_OBJECT(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { return invoke<Any>(0x2F7AA05C, p0, p1, p2, p3, p4, p5, p6); } // 0x2F7AA05C
    ...
    static void DELETE_OBJECT(Any p0) { invoke<Void>(0xD6EF9DA7, p0); } // 0xD6EF9DA7
    static Any PLACE_OBJECT_ON_GROUND_PROPERLY(Any p0) { return invoke<Any>(0x8F95A20B, p0); } // 0x8F95A20B
    ...
    static void SET_OBJECT_TARGETTABLE(Any p0, Any p1) { invoke<Void>(0x3F88CD86, p0, p1); } // 0x3F88CD86
    static void _0x483C5C88(Any p0, Any p1) { invoke<Void>(0x483C5C88, p0, p1); } // 0x483C5C88
    static Any GET_CLOSEST_OBJECT_OF_TYPE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { return invoke<Any>(0x45619B33, p0, p1, p2, p3, p4, p5); } // 0x45619B33
    ...
    static void SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0x38C951A4, p0, p1, p2, p3, p4, p5, p6); } // 0x38C951A4
    static void GET_STATE_OF_CLOSEST_DOOR_OF_TYPE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x4B44A83D, p0, p1, p2, p3, p4, p5); } // 0x4B44A83D
    ...
    static void _0x9D2D778D(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0x9D2D778D, p0, p1, p2, p3, p4, p5, p6, p7); } // 0x9D2D778D
    static void _0x00253286(Any p0) { invoke<Void>(0x00253286, p0); } // 0x00253286
    static void _0xDF83DB47(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xDF83DB47, p0, p1, p2, p3); } // 0xDF83DB47
    ...
    static Any CREATE_PICKUP(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { return invoke<Any>(0x5E14DF68, p0, p1, p2, p3, p4, p5, p6, p7); } // 0x5E14DF68
    static Any CREATE_PICKUP_ROTATE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11) { return invoke<Any>(0xF015BFE2, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); } // 0xF015BFE2
    static Any CREATE_AMBIENT_PICKUP(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { return invoke<Any>(0x17B99CE7, p0, p1, p2, p3, p4, p5, p6, p7, p8); } // 0x17B99CE7
    ...
    static Vector3 GET_SAFE_PICKUP_COORDS(Any p0, Any p1, Any p2, Any p3, Any p4) { return invoke<Vector3>(0x618B5F67, p0, p1, p2, p3, p4); } // 0x618B5F67
    ...
    static void CREATE_MONEY_PICKUPS(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x36C9A5EA, p0, p1, p2, p3, p4, p5); } // 0x36C9A5EA
...
namespace AI
{
    ...
    static void TASK_JUMP(Any p0, Any p1) { invoke<Void>(0x0356E3CE, p0, p1); } // 0x0356E3CE
    static void TASK_COWER(Any p0, Any p1) { invoke<Void>(0x9CF1C19B, p0, p1); } // 0x9CF1C19B
    static void TASK_HANDS_UP(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x8DCC19C5, p0, p1, p2, p3, p4); } // 0x8DCC19C5
    ...
    static void TASK_ENTER_VEHICLE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0xB8689B4E, p0, p1, p2, p3, p4, p5, p6); } // 0xB8689B4E
    static void TASK_LEAVE_VEHICLE(Any p0, Any p1, Any p2) { invoke<Void>(0x7B1141C6, p0, p1, p2); } // 0x7B1141C6
    ...
    static void TASK_VEHICLE_DRIVE_TO_COORD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10) { invoke<Void>(0xE4AC0387, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); } // 0xE4AC0387
    static void TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0x1490182A, p0, p1, p2, p3, p4, p5, p6, p7); } // 0x1490182A
    static void TASK_VEHICLE_DRIVE_WANDER(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x36EC0EB0, p0, p1, p2, p3); } // 0x36EC0EB0
    ...
    static void TASK_WANDER_STANDARD(Any p0, Any p1, Any p2) { invoke<Void>(0xAF59151A, p0, p1, p2); } // 0xAF59151A
    static void TASK_VEHICLE_PARK(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0x5C85FF90, p0, p1, p2, p3, p4, p5, p6, p7, p8); } // 0x5C85FF90
    static void TASK_STEALTH_KILL(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x0D64C2FA, p0, p1, p2, p3, p4); } // 0x0D64C2FA
    static void TASK_PLANT_BOMB(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x33457535, p0, p1, p2, p3, p4); } // 0x33457535
    ...
    static void SET_PED_PATH_CAN_USE_CLIMBOVERS(Any p0, Any p1) { invoke<Void>(0xB7B7D442, p0, p1); } // 0xB7B7D442
    static void SET_PED_PATH_CAN_USE_LADDERS(Any p0, Any p1) { invoke<Void>(0x53A879EE, p0, p1); } // 0x53A879EE
    static void SET_PED_PATH_CAN_DROP_FROM_HEIGHT(Any p0, Any p1) { invoke<Void>(0x394B7AC9, p0, p1); } // 0x394B7AC9
    static void _0x55E06443(Any p0, Any p1) { invoke<Void>(0x55E06443, p0, p1); } // 0x55E06443
    ...
    static void TASK_PLAY_ANIM(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10) { invoke<Void>(0x5AB552C6, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); } // 0x5AB552C6
    ...
    static void OPEN_SEQUENCE_TASK(Any p0) { invoke<Void>(0xABA6923E, p0); } // 0xABA6923E
    static void CLOSE_SEQUENCE_TASK(Any p0) { invoke<Void>(0x1A7CEBD0, p0); } // 0x1A7CEBD0
    static void TASK_PERFORM_SEQUENCE(Any p0, Any p1) { invoke<Void>(0x4D9FBD11, p0, p1); } // 0x4D9FBD11
    static void CLEAR_SEQUENCE_TASK(Any p0) { invoke<Void>(0x47ED03CE, p0); } // 0x47ED03CE
    ...
    static void _0x67E73525(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x67E73525, p0, p1, p2, p3, p4, p5); } // 0x67E73525
    static Any _0x249EB4EB(Any p0) { return invoke<Any>(0x249EB4EB, p0); } // 0x249EB4EB
    static void TASK_AIM_GUN_AT_ENTITY(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xBE32B3B6, p0, p1, p2, p3); } // 0xBE32B3B6
    static void TASK_TURN_PED_TO_FACE_ENTITY(Any p0, Any p1, Any p2) { invoke<Void>(0x3C37C767, p0, p1, p2); } // 0x3C37C767
    ...
    static void CLEAR_PED_TASKS(Any p0) { invoke<Void>(0xDE3316AB, p0); } // 0xDE3316AB
    // 0x9226734D -- no params/results data
    static void CLEAR_PED_SECONDARY_TASK(Any p0) { invoke<Void>(0xA635F451, p0); } // 0xA635F451
    ...
    static void TASK_VEHICLE_ESCORT(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0x9FDCB250, p0, p1, p2, p3, p4, p5, p6, p7, p8); } // 0x9FDCB250
    static void TASK_VEHICLE_FOLLOW(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0xA8B917D7, p0, p1, p2, p3, p4, p5); } // 0xA8B917D7
    static void TASK_VEHICLE_CHASE(Any p0, Any p1) { invoke<Void>(0x55634798, p0, p1); } // 0x55634798
    static void TASK_VEHICLE_HELI_PROTECT(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0x0CB415EE, p0, p1, p2, p3, p4, p5, p6); } // 0x0CB415EE
    ...
    static void TASK_PLANE_CHASE(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x12FA1C28, p0, p1, p2, p3, p4); } // 0x12FA1C28
    ...
    static void _0x9B76F7E6(Any p0) { invoke<Void>(0x9B76F7E6, p0); } // 0x9B76F7E6
    static Any _0xB23F46E6(Any p0) { return invoke<Any>(0xB23F46E6, p0); } // 0xB23F46E6
    ...
    static void TASK_SHOOT_AT_ENTITY(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xAC0631C9, p0, p1, p2, p3); } // 0xAC0631C9
    ...
    static void CLEAR_PED_TASKS_IMMEDIATELY(Any p0) { invoke<Void>(0xBC045625, p0); } // 0xBC045625
    ...
    static Any _0x29F97A71(Any p0, Any p1, Any p2) { return invoke<Any>(0x29F97A71, p0, p1, p2); } // 0x29F97A71
    static Vector3 _0xC6B6CCC1(Any p0) { return invoke<Vector3>(0xC6B6CCC1, p0); } // 0xC6B6CCC1
    static void TASK_COMBAT_PED(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xCB0D8932, p0, p1, p2, p3); } // 0xCB0D8932
    ...
    static void _0x59C5FAD7(Any p0, Any p1) { invoke<Void>(0x59C5FAD7, p0, p1); } // 0x59C5FAD7
    ...
    static void TASK_START_SCENARIO_IN_PLACE(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xE50D6DDE, p0, p1, p2, p3); } // 0xE50D6DDE
    ...
    static void TASK_COMBAT_HATED_TARGETS_AROUND_PED(Any p0, Any p1, Any p2) { invoke<Void>(0x2E7064E4, p0, p1, p2); } // 0x2E7064E4
    ...
    static void ASSISTED_MOVEMENT_REQUEST_ROUTE(Any p0) { invoke<Void>(0x48262EDA, p0); } // 0x48262EDA
    ...
    static BOOL IS_PED_STILL(Ped p) { return invoke<BOOL>(0x09E3418D, p); } // 0x09E3418D
    static BOOL IS_PED_WALKING(Ped p) { return invoke<BOOL>(0x4B865C4A, p); } // 0x4B865C4A
    static BOOL IS_PED_RUNNING(Ped p) { return invoke<BOOL>(0xE9A5578F, p); } // 0xE9A5578F
    static BOOL IS_PED_SPRINTING(Ped p) { return invoke<BOOL>(0x4F3E0633, p); } // 0x4F3E0633
    static BOOL IS_PED_STRAFING(Ped p) { return invoke<BOOL>(0xEFEED13C, p); } // 0xEFEED13C
    ...
    static void _0x4D210467(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0x4D210467, p0, p1, p2, p3, p4, p5, p6, p7, p8); } // 0x4D210467
    static void _0xF65F0F4F(Any p0, Any p1) { invoke<Void>(0xF65F0F4F, p0, p1); } // 0xF65F0F4F
...
namespace GAMEPLAY
{
    static Any _0x4E9CA30A() { return invoke<Any>(0x4E9CA30A); } // 0x4E9CA30A
    static Any _0x11A178B8(Any p0) { return invoke<Any>(0x11A178B8, p0); } // 0x11A178B8
    static void SET_RANDOM_SEED(Any p0) { invoke<Void>(0xDB3FEB5C, p0); } // 0xDB3FEB5C
    static void SET_TIME_SCALE(Any p0) { invoke<Void>(0xA7F84694, p0); } // 0xA7F84694
    ...
    static void SET_WEATHER_TYPE_PERSIST(Any p0) { invoke<Void>(0xC6C04C75, p0); } // 0xC6C04C75
    static void SET_WEATHER_TYPE_NOW_PERSIST(LPCSTR weatherName) { invoke<Void>(0xC869FE97, weatherName); } // 0xC869FE97
    static void SET_WEATHER_TYPE_NOW(Any p0) { invoke<Void>(0x361E9EAC, p0); } // 0x361E9EAC
    static void _0x386F0D25(Any p0, Any p1) { invoke<Void>(0x386F0D25, p0, p1); } // 0x386F0D25
    ...
    static void SET_OVERRIDE_WEATHER(Any p0) { invoke<Void>(0xD9082BB5, p0); } // 0xD9082BB5
    ...
    static void SET_WIND(float f) { invoke<Void>(0xC6294698, f); } // 0xC6294698
    ...
    static void SET_WIND_DIRECTION(float f) { invoke<Void>(0x381AEEE9, f); } // 0x381AEEE9
    ...
    static void _0xED88FC61(Any p0, Any p1) { invoke<Void>(0xED88FC61, p0, p1); } // 0xED88FC61
    ...
    static Any GET_GAME_TIMER() { return invoke<Any>(0xA4EA0691); } // 0xA4EA0691
    static Any GET_FRAME_TIME() { return invoke<Any>(0x96374262); } // 0x96374262
    static Any GET_FRAME_COUNT() { return invoke<Any>(0xB477A015); } // 0xB477A015
    static Any GET_RANDOM_FLOAT_IN_RANGE(Any p0, Any p1) { return invoke<Any>(0x0562C4D0, p0, p1); } // 0x0562C4D0
    static Any GET_RANDOM_INT_IN_RANGE(Any p0, Any p1) { return invoke<Any>(0x4051115B, p0, p1); } // 0x4051115B
    static BOOL GET_GROUND_Z_FOR_3D_COORD(float x, float y, float z, float *pZ) { return invoke<BOOL>(0xA1BFD5E0, x, y, z, pZ); } // 0xA1BFD5E0
    ...
    static Any GET_DISTANCE_BETWEEN_COORDS(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { return invoke<Any>(0xF698765E, p0, p1, p2, p3, p4, p5, p6); } // 0xF698765E
    ...
    static void SET_BIT(Any p0, Any p1) { invoke<Void>(0x4EFE7E6B, p0, p1); } // 0x4EFE7E6B
    static void CLEAR_BIT(Any p0, Any p1) { invoke<Void>(0x8BC9E618, p0, p1); } // 0x8BC9E618
    static Hash GET_HASH_KEY(LPCSTR str) { return invoke<Any>(0x98EFF6F1, str); } // 0x98EFF6F1
    ...
    static void CLEAR_AREA_OF_PEDS(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x25BE7FA8, p0, p1, p2, p3, p4); } // 0x25BE7FA8
    ...
    static void TERMINATE_ALL_SCRIPTS_WITH_THIS_NAME(Any p0) { invoke<Void>(0x9F861FD4, p0); } // 0x9F861FD4
    ...
    static void SHOOT_SINGLE_BULLET_BETWEEN_COORDS(float x1, float y1, float z1, float x2, float y2, float z2, int unk1, BOOL unk2, Hash weaponBullet, Ped shooter, BOOL unk3, BOOL unk4, float unk5) { invoke<Void>(0xCB7415AC, x1, y1, z1, x2, y2, z2, unk1, unk2, weaponBullet, shooter, unk3, unk4, unk5); } // 0xCB7415AC
    ...
    static void GET_MODEL_DIMENSIONS(Hash model, Vector3 *pV0, Vector3 *pV1) { invoke<Void>(0x91ABB8E0, model, pV0, pV1); } // 0x91ABB8E0
    static void SET_FAKE_WANTED_LEVEL(Any p0) { invoke<Void>(0x85B1C9FA, p0); } // 0x85B1C9FA
    static BOOL IS_BIT_SET(Any p0, Any p1) { return invoke<BOOL>(0x902E26AC, p0, p1); } // 0x902E26AC
    ...
    static Any GET_PROFILE_SETTING(Any p0) { return invoke<Any>(0xD374BEBC, p0); } // 0xD374BEBC
    static BOOL ARE_STRINGS_EQUAL(Any p0, Any p1) { return invoke<BOOL>(0x877C0BC5, p0, p1); } // 0x877C0BC5
    ...
    static Any STRING_TO_INT(Any p0, Any p1) { return invoke<Any>(0x590A8160, p0, p1); } // 0x590A8160
    ...
    static void SET_GAME_PAUSED(Any p0) { invoke<Void>(0x8230FF6C, p0); } // 0x8230FF6C
    ...
    static void SET_GRAVITY_LEVEL(BOOL b) { invoke<Void>(0x2D833F4A, b); } // 0x2D833F4A
    ...
    static void DISPLAY_ONSCREEN_KEYBOARD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0xAD99F2CE, p0, p1, p2, p3, p4, p5, p6, p7); } // 0xAD99F2CE
    static Any UPDATE_ONSCREEN_KEYBOARD() { return invoke<Any>(0x23D0A1CE); } // 0x23D0A1CE
    static Any GET_ONSCREEN_KEYBOARD_RESULT() { return invoke<Any>(0x44828FB3); } // 0x44828FB3
    ...
    static void SET_EXPLOSIVE_AMMO_THIS_FRAME(Player p) { invoke<Void>(0x2EAFA1D1, p); } // 0x2EAFA1D1
    static void SET_FIRE_AMMO_THIS_FRAME(Player p) { invoke<Void>(0x7C18FC8A, p); } // 0x7C18FC8A
    static void SET_EXPLOSIVE_MELEE_THIS_FRAME(Player p) { invoke<Void>(0x96663D56, p); } // 0x96663D56
    static void SET_SUPER_JUMP_THIS_FRAME(Player p) { invoke<Void>(0x86745EF3, p); } // 0x86745EF3
...
namespace AUDIO
{
    ...
    static void PLAY_SOUND_FRONTEND(int t, LPCSTR sound, LPCSTR soundSet) { invoke<Void>(0x2E458F74, t, sound, soundSet); } // 0x2E458F74
    static void PLAY_SOUND_FROM_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x95AE00F8, p0, p1, p2, p3, p4, p5); } // 0x95AE00F8
    ...
    static void _0x5C57B85D(Any p0, Any p1, Any p2) { invoke<Void>(0x5C57B85D, p0, p1, p2); } // 0x5C57B85D
    static void _0x444180DB(Any p0, Any p1, Any p2) { invoke<Void>(0x444180DB, p0, p1, p2); } // 0x444180DB
    ...
    static Any GET_RADIO_STATION_NAME(Any p0) { return invoke<Any>(0x3DF493BC, p0); } // 0x3DF493BC
    ...
    static void SET_RADIO_TO_STATION_NAME(Any p0) { invoke<Void>(0x7B36E35E, p0); } // 0x7B36E35E
    static void SET_VEH_RADIO_STATION(Any p0, Any p1) { invoke<Void>(0xE391F55F, p0, p1); } // 0xE391F55F
    ...
    static int GET_AUDIBLE_MUSIC_TRACK_TEXT_ID() { return invoke<int>(0xA2B88CA7); } // 0xA2B88CA7
    ...
    static void SET_VEHICLE_RADIO_LOUD(Any p0, Any p1) { invoke<Void>(0x8D9EDD99, p0, p1); } // 0x8D9EDD99
    static Any _0xCBA99F4A(Any p0) { return invoke<Any>(0xCBA99F4A, p0); } // 0xCBA99F4A
    static void SET_MOBILE_RADIO_ENABLED_DURING_GAMEPLAY(Any p0) { invoke<Void>(0x990085F0, p0); } // 0x990085F0
    ...
    static Any PLAY_POLICE_REPORT(Any p0, Any p1) { return invoke<Any>(0x3F277B62, p0, p1); } // 0x3F277B62
    static void BLIP_SIREN(Any p0) { invoke<Void>(0xC0EB6924, p0); } // 0xC0EB6924
    static void OVERRIDE_VEH_HORN(Any p0, Any p1, Any p2) { invoke<Void>(0x2ACAB783, p0, p1, p2); } // 0x2ACAB783
    static BOOL IS_HORN_ACTIVE(Any p0) { return invoke<BOOL>(0x20E2BDD0, p0); } // 0x20E2BDD0
    static void SET_AGGRESSIVE_HORNS(Any p0) { invoke<Void>(0x01D6EABE, p0); } // 0x01D6EABE
    ...
    static void SET_VEHICLE_BOOST_ACTIVE(Any p0, Any p1) { invoke<Void>(0x072F15F2, p0, p1); } // 0x072F15F2
    ...
    static void PLAY_MISSION_COMPLETE_AUDIO(Any p0) { invoke<Void>(0x3033EA1D, p0); } // 0x3033EA1D
    ...
    static void _0xE6B033BF() { invoke<Void>(0xE6B033BF); } // 0xE6B033BF
...
namespace CUTSCENE
{
    static void REQUEST_CUTSCENE(Any p0, Any p1) { invoke<Void>(0xB5977853, p0, p1); } // 0xB5977853
...
namespace INTERIOR
{
    ...
    static Any _0x96525B06(Any p0, Any p1, Any p2, Any p3) { return invoke<Any>(0x96525B06, p0, p1, p2, p3); } // 0x96525B06
...
namespace CAM
{
    ...
    static Cam CREATE_CAM(LPCSTR name, BOOL unk) { return invoke<Cam>(0xE9BF2A7D, name, unk); } // 0xE9BF2A7D
    static Cam CREATE_CAM_WITH_PARAMS(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9) { return invoke<Cam>(0x23B02F15, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); } // 0x23B02F15
    static Cam CREATE_CAMERA(Any p0, Any p1) { return invoke<Cam>(0x5D6739AE, p0, p1); } // 0x5D6739AE
    static Cam CREATE_CAMERA_WITH_PARAMS(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9) { return invoke<Cam>(0x0688BE9A, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); } // 0x0688BE9A
    static void DESTROY_CAM(Cam cam, BOOL unk) { invoke<Void>(0xC39302BD, cam, unk); } // 0xC39302BD
    static void DESTROY_ALL_CAMS(Any p0) { invoke<Void>(0x10C151CE, p0); } // 0x10C151CE
    static BOOL DOES_CAM_EXIST(Cam cam) { return invoke<BOOL>(0x1EF89DC0, cam); } // 0x1EF89DC0
    ...
    static Any GET_CAM_FOV(Any p0) { return invoke<Any>(0xD6E9FCF5, p0); } // 0xD6E9FCF5
    ...
    static void SET_CAM_ROT(Cam cam, float x, float y, float z, int mode) { invoke<Void>(0xEE38B3C1, cam, x, y, z, mode); } // 0xEE38B3C1
    static void SET_CAM_FOV(Cam cam, float val) { invoke<Void>(0xD3D5D74F, cam, val); } // 0xD3D5D74F
    ...
    static void ATTACH_CAM_TO_PED_BONE(Cam cam, Ped p, int boneId, float x, float y, float z, BOOL unk) { invoke<Void>(0x506BB35C, cam, p, boneId, x, y, z, unk); } // 0x506BB35C
    static void DETACH_CAM(Any p0) { invoke<Void>(0xF4FBF14A, p0); } // 0xF4FBF14A
    ...
    static void SET_CAM_ACTIVE_WITH_INTERP(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x7983E7F0, p0, p1, p2, p3, p4); } // 0x7983E7F0
    ...
    static BOOL IS_CAM_TRANSITIONING(Any p0) { return invoke<BOOL>(0xE905BC7E, p0); } // 0xE905BC7E
    ...
    static void DO_SCREEN_FADE_IN(Any p0) { invoke<Void>(0x66C1BDEE, p0); } // 0x66C1BDEE
    static void DO_SCREEN_FADE_OUT(Any p0) { invoke<Void>(0x89D01805, p0); } // 0x89D01805
    static void SET_WIDESCREEN_BORDERS(Any p0, Any p1) { invoke<Void>(0x1A75DC9A, p0, p1); } // 0x1A75DC9A
    static Vector3 GET_GAMEPLAY_CAM_COORD() { return invoke<Vector3>(0x9388CF79); } // 0x9388CF79
    static Vector3 GET_GAMEPLAY_CAM_ROT(int mode) { return invoke<Vector3>(0x13A010B5, mode); } // 0x13A010B5
    ...
    static void SET_GAMEPLAY_CAM_RELATIVE_HEADING(Any p0) { invoke<Void>(0x20C6217C, p0); } // 0x20C6217C
    static Any GET_GAMEPLAY_CAM_RELATIVE_PITCH() { return invoke<Any>(0xFC5A4946); } // 0xFC5A4946
    static void SET_GAMEPLAY_CAM_RELATIVE_PITCH(Any p0, Any p1) { invoke<Void>(0x6381B963, p0, p1); } // 0x6381B963
    ...
    static void _0x749909AC(Any p0, Any p1) { invoke<Void>(0x749909AC, p0, p1); } // 0x749909AC
    static void _0xFA3A16E7(Any p0, Any p1) { invoke<Void>(0xFA3A16E7, p0, p1); } // 0xFA3A16E7
    static void _0x77340650(Any p0, Any p1) { invoke<Void>(0x77340650, p0, p1); } // 0x77340650
    static void _0x4B22C5CB(Any p0, Any p1) { invoke<Void>(0x4B22C5CB, p0, p1); } // 0x4B22C5CB
    ...
    static void _0x9F4AF763(Any p0) { invoke<Void>(0x9F4AF763, p0); } // 0x9F4AF763
    ...
    static Any _0x2939D0B6(Any p0, Any p1, Any p2) { return invoke<Any>(0x2939D0B6, p0, p1, p2); } // 0x2939D0B6
    static void SET_CINEMATIC_MODE_ACTIVE(Any p0) { invoke<Void>(0x2009E747, p0); } // 0x2009E747
    static void _0xAA2B89E0() { invoke<Void>(0xAA2B89E0); } // 0xAA2B89E0
...
namespace WEAPON
{
    ...
    static void SET_CURRENT_PED_WEAPON(Any p0, Any p1, Any p2) { invoke<Void>(0xB8278882, p0, p1, p2); } // 0xB8278882
    static BOOL GET_CURRENT_PED_WEAPON(Ped ped, Hash *pWeapon, BOOL b) { return invoke<BOOL>(0xB0237302, ped, pWeapon, b); } // 0xB0237302
    ...
    static BOOL IS_WEAPON_VALID(Any p0) { return invoke<BOOL>(0x38CA2954, p0); } // 0x38CA2954
    ...
    static void ADD_AMMO_TO_PED(Any p0, Any p1, Any p2) { invoke<Void>(0x7F0580C7, p0, p1, p2); } // 0x7F0580C7
    static void SET_PED_AMMO(Ped ped, Hash weapon, int ammo) { invoke<Void>(0xBF90DF1A, ped, weapon, ammo); } // 0xBF90DF1A
    static void SET_PED_INFINITE_AMMO(Any p0, Any p1, Any p2) { invoke<Void>(0x9CB8D278, p0, p1, p2); } // 0x9CB8D278
    static void _0x5A5E3B67(Any p0, Any p1) { invoke<Void>(0x5A5E3B67, p0, p1); } // 0x5A5E3B67
    static void GIVE_WEAPON_TO_PED(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0xC4D88A85, p0, p1, p2, p3, p4); } // 0xC4D88A85
    static void GIVE_DELAYED_WEAPON_TO_PED(Ped p, Hash weapon, int ammo, BOOL b) { invoke<Void>(0x5868D20D, p, weapon, ammo, b); } // 0x5868D20D
    static void REMOVE_ALL_PED_WEAPONS(Any p0, Any p1) { invoke<Void>(0xA44CE817, p0, p1); } // 0xA44CE817
    static void REMOVE_WEAPON_FROM_PED(Any p0, Any p1) { invoke<Void>(0x9C37F220, p0, p1); } // 0x9C37F220
    static void HIDE_PED_WEAPON_FOR_SCRIPTED_CUTSCENE(Any p0, Any p1) { invoke<Void>(0x00CFD6E9, p0, p1); } // 0x00CFD6E9
    ...
    static void CLEAR_PED_LAST_WEAPON_DAMAGE(Any p0) { invoke<Void>(0x52C68832, p0); } // 0x52C68832
    ...
    static int GET_MAX_AMMO_IN_CLIP(Ped ped, Hash weapon, BOOL b) { return invoke<int>(0x6961E2A4, ped, weapon, b); } // 0x6961E2A4
    static Any GET_AMMO_IN_CLIP(Any p0, Any p1, Any p2) { return invoke<Any>(0x73C100C3, p0, p1, p2); } // 0x73C100C3
    static Any SET_AMMO_IN_CLIP(Ped ped, Hash weapon, int ammo) { return invoke<Any>(0xA54B0B10, ped, weapon, ammo); } // 0xA54B0B10
    static Any GET_MAX_AMMO(Any p0, Any p1, Any p2) { return invoke<Any>(0x0B294796, p0, p1, p2); } // 0x0B294796
    ...
    static Any GET_PED_LAST_WEAPON_IMPACT_COORD(Any p0, Any p1) { return invoke<Any>(0x9B266079, p0, p1); } // 0x9B266079
    ...
    static void REQUEST_WEAPON_ASSET(Hash name, int type, int unk) { invoke<Void>(0x65D139A5, name, type, unk); } // 0x65D139A5
    static BOOL HAS_WEAPON_ASSET_LOADED(Hash name) { return invoke<BOOL>(0x1891D5BB, name); } // 0x1891D5BB
    static void REMOVE_WEAPON_ASSET(Hash name) { invoke<Void>(0x2C0DFE3C, name); } // 0x2C0DFE3C
    ...
    static void SET_PED_WEAPON_TINT_INDEX(Any p0, Any p1, Any p2) { invoke<Void>(0xEB2A7B23, p0, p1, p2); } // 0xEB2A7B23
...
namespace STREAMING
{
    ...
    static void _0x0B7E0F0A() { invoke<Void>(0x0B7E0F0A); } // 0x0B7E0F0A
    static void REQUEST_COLLISION_AT_COORD(Any p0, Any p1, Any p2) { invoke<Void>(0xCD9805E7, p0, p1, p2); } // 0xCD9805E7
    static void REQUEST_COLLISION_FOR_MODEL(Any p0) { invoke<Void>(0x3930C042, p0); } // 0x3930C042
    ...
    static void REQUEST_ANIM_DICT(Any p0) { invoke<Void>(0xDCA96950, p0); } // 0xDCA96950
    static BOOL HAS_ANIM_DICT_LOADED(Any p0) { return invoke<BOOL>(0x05E6763C, p0); } // 0x05E6763C
    ...
    static void REQUEST_CLIP_SET(Any p0) { invoke<Void>(0x546C627A, p0); } // 0x546C627A
    static BOOL HAS_CLIP_SET_LOADED(Any p0) { return invoke<BOOL>(0x230D5455, p0); } // 0x230D5455
    static void REMOVE_CLIP_SET(Any p0) { invoke<Void>(0x1E21F7AA, p0); } // 0x1E21F7AA
    static void REQUEST_IPL(Any p0) { invoke<Void>(0x3B70D1DB, p0); } // 0x3B70D1DB
    static void REMOVE_IPL(Any p0) { invoke<Void>(0xDF7CBD36, p0); } // 0xDF7CBD36
    static BOOL IS_IPL_ACTIVE(Any p0) { return invoke<BOOL>(0xB2C33714, p0); } // 0xB2C33714
...
namespace SCRIPT
{
    static void REQUEST_SCRIPT(LPSTR name) { invoke<Void>(0xE26B2666, name); } // 0xE26B2666
    static void SET_SCRIPT_AS_NO_LONGER_NEEDED(LPSTR name) { invoke<Void>(0x6FCB7795, name); } // 0x6FCB7795
    static BOOL HAS_SCRIPT_LOADED(LPSTR name) { return invoke<BOOL>(0x5D67F751, name); } // 0x5D67F751
    static BOOL DOES_SCRIPT_EXIST(LPSTR name) { return invoke<BOOL>(0xDEAB87AB, name); } // 0xDEAB87AB
    static void TERMINATE_THREAD(int tid) { invoke<Void>(0x253FD520, tid); } // 0x253FD520
    static BOOL IS_THREAD_ACTIVE(int tid) { return invoke<BOOL>(0x78D7A5A0, tid); } // 0x78D7A5A0
    static Any _0xBE7ACD89(Any p0) { return invoke<Any>(0xBE7ACD89, p0); } // 0xBE7ACD89
    ...
    static Any _0x029D3841(Hash script) { return invoke<Any>(0x029D3841, script); } // 0x029D3841
    static Any GET_THIS_SCRIPT_NAME() { return invoke<Any>(0xA40FD5D9); } // 0xA40FD5D9
    ...
    static void SET_NO_LOADING_SCREEN(Any p0) { invoke<Void>(0xC8055034, p0); } // 0xC8055034
    static void _0xB03BCCDF() { invoke<Void>(0xB03BCCDF); } // 0xB03BCCDF
    // 0xCDC9D654 -- no params/results data
}
namespace UI
{
    static void _0xCB7C8994(Any p0) { invoke<Void>(0xCB7C8994, p0); } // 0xCB7C8994
    static void _0x903F5EE4(Any p0) { invoke<Void>(0x903F5EE4, p0); } // 0x903F5EE4
    ...
    static Any _0x08F7AF78(Any p0, Any p1) { return invoke<Any>(0x08F7AF78, p0, p1); } // 0x08F7AF78
    ...
    static void _0xF42C43C7(Any p0) { invoke<Void>(0xF42C43C7, p0); } // 0xF42C43C7
    static void _0x38F82261(Any p0, Any p1) { invoke<Void>(0x38F82261, p0, p1); } // 0x38F82261
    ...
    static void _SET_TEXT_ENTRY(LPCSTR gxtEntry) { invoke<Void>(0x3E35563E, gxtEntry); } // 0x3E35563E
    ...
    static void _0x94B82066(LPSTR gxtEntry) { invoke<Void>(0x94B82066, gxtEntry); } // 0x94B82066
    static int _0xAA318785(float x, float y) { return invoke<int>(0xAA318785, x, y); } // 0xAA318785
    ...
    static void ADD_TEXT_COMPONENT_INTEGER(Any p0) { invoke<Void>(0xFE272A57, p0); } // 0xFE272A57
    static void ADD_TEXT_COMPONENT_FLOAT(Any p0, Any p1) { invoke<Void>(0x24D78013, p0, p1); } // 0x24D78013
    ...
    static void _ADD_TEXT_COMPONENT_STRING(LPCSTR str) { invoke<Void>(0x27A244D8, str); } // 0x27A244D8
    ...
    static void _0xC736999E(Any p0) { invoke<Void>(0xC736999E, p0); } // 0xC736999E
    static void _0x0829A799(Any p0) { invoke<Void>(0x0829A799, p0); } // 0x0829A799
    ...
    static void REQUEST_ADDITIONAL_TEXT(LPCSTR gxt, int slot) { invoke<Void>(0x9FA9175B, gxt, slot); } // 0x9FA9175B
    static BOOL HAS_ADDITIONAL_TEXT_LOADED(int slot) { return invoke<BOOL>(0xB0E56045, slot); } // 0xB0E56045
    ...
    static BOOL DOES_TEXT_LABEL_EXIST(LPCSTR gxtEntry) { return invoke<BOOL>(0x6ECAE560, gxtEntry); } // 0x6ECAE560
    static Any GET_LENGTH_OF_STRING_WITH_THIS_TEXT_LABEL(Any p0) { return invoke<Any>(0xA4CA7BE5, p0); } // 0xA4CA7BE5
    static Any GET_LENGTH_OF_LITERAL_STRING(Any p0) { return invoke<Any>(0x99379D55, p0); } // 0x99379D55
    ...
    static void DISPLAY_HUD(Any p0) { invoke<Void>(0xD10E4E31, p0); } // 0xD10E4E31
    static void _0xC380AC85() { invoke<Void>(0xC380AC85); } // 0xC380AC85
    static void _0xC47AB1B0() { invoke<Void>(0xC47AB1B0); } // 0xC47AB1B0
    static void DISPLAY_RADAR(Any p0) { invoke<Void>(0x52816BD4, p0); } // 0x52816BD4
    ...
    static void SET_BLIP_ROUTE(Any p0, Any p1) { invoke<Void>(0x3E160C90, p0, p1); } // 0x3E160C90
    ...
    static void SET_RADAR_ZOOM(Any p0) { invoke<Void>(0x2A50D1A6, p0); } // 0x2A50D1A6
    ...
    static void FLASH_WANTED_DISPLAY(Any p0) { invoke<Void>(0x629F866B, p0); } // 0x629F866B
    static float _0x3330175B(float x, float y) { return invoke<float>(0x3330175B, x, y); } // 0x3330175B
    static void SET_TEXT_SCALE(float x, float y) { invoke<Void>(0xB6E15B23, x, y); } // 0xB6E15B23
    static void SET_TEXT_COLOUR(int r, int g, int b, int a) { invoke<Void>(0xE54DD2C8, r, g, b, a); } // 0xE54DD2C8
    static void SET_TEXT_CENTRE(BOOL b) { invoke<Void>(0xE26D39A1, b); } // 0xE26D39A1
    static void SET_TEXT_RIGHT_JUSTIFY(BOOL b) { invoke<Void>(0x45B60520, b); } // 0x45B60520
    static void _0x68CDFA60(Any p0) { invoke<Void>(0x68CDFA60, p0); } // 0x68CDFA60
    static void SET_TEXT_WRAP(float x, float y) { invoke<Void>(0x6F60AB54, x, y); } // 0x6F60AB54
    ...
    static void SET_TEXT_EDGE(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x3F1A5DAB, p0, p1, p2, p3, p4); } // 0x3F1A5DAB
    ...
    static void CLEAR_HELP(Any p0) { invoke<Void>(0xE6D85741, p0); } // 0xE6D85741
    ...
    static int _GET_BLIP_INFO_ID_ITERATOR() { return invoke<int>(0xB9827942); } // 0xB9827942
    static int GET_NUMBER_OF_ACTIVE_BLIPS() { return invoke<int>(0x144020FA); } // 0x144020FA
    static Blip GET_NEXT_BLIP_INFO_ID(int blipIterator) { return invoke<Blip>(0x9356E92F, blipIterator); } // 0x9356E92F
    static Blip GET_FIRST_BLIP_INFO_ID(int blipIterator) { return invoke<Blip>(0x64C0273D, blipIterator); } // 0x64C0273D
    static Vector3 GET_BLIP_INFO_ID_COORD(Blip b) { return invoke<Vector3>(0xB7374A66, b); } // 0xB7374A66
    static int GET_BLIP_INFO_ID_DISPLAY(Blip b) { return invoke<int>(0xD0FC19F4, b); } // 0xD0FC19F4
    static int GET_BLIP_INFO_ID_TYPE(Blip b) { return invoke<int>(0x501D7B4E, b); } // 0x501D7B4E
    static int GET_BLIP_INFO_ID_ENTITY_INDEX(Blip b) { return invoke<int>(0xA068C40B, b); } // 0xA068C40B
    static int GET_BLIP_INFO_ID_PICKUP_INDEX(Blip b) { return invoke<int>(0x86913D37, b); } // 0x86913D37
    static Any GET_BLIP_FROM_ENTITY(Any p0) { return invoke<Any>(0x005A2A47, p0); } // 0x005A2A47
    static Any ADD_BLIP_FOR_RADIUS(Any p0, Any p1, Any p2, Any p3) { return invoke<Any>(0x4626756C, p0, p1, p2, p3); } // 0x4626756C
    static Any ADD_BLIP_FOR_ENTITY(Any p0) { return invoke<Any>(0x30822554, p0); } // 0x30822554
    static Any ADD_BLIP_FOR_PICKUP(Any p0) { return invoke<Any>(0x16693C3A, p0); } // 0x16693C3A
    static Any ADD_BLIP_FOR_COORD(Any p0, Any p1, Any p2) { return invoke<Any>(0xC6F43D0E, p0, p1, p2); } // 0xC6F43D0E
    ...
    static void SET_BLIP_SPRITE(Any p0, Any p1) { invoke<Void>(0x8DBBB0B9, p0, p1); } // 0x8DBBB0B9
    static Any GET_BLIP_SPRITE(Any p0) { return invoke<Any>(0x72FF2E73, p0); } // 0x72FF2E73
    static void SET_BLIP_NAME_FROM_TEXT_FILE(Any p0, Any p1) { invoke<Void>(0xAC8A5461, p0, p1); } // 0xAC8A5461
    ...
    static void SET_BLIP_COLOUR(Any p0, Any p1) { invoke<Void>(0xBB3C5A41, p0, p1); } // 0xBB3C5A41
    ...
    static void SET_BLIP_FLASHES_ALTERNATE(Any p0, Any p1) { invoke<Void>(0x1A81202B, p0, p1); } // 0x1A81202B
    ...
    static void SET_BLIP_SCALE(Any p0, Any p1) { invoke<Void>(0x1E6EC434, p0, p1); } // 0x1E6EC434
    static void SET_BLIP_PRIORITY(Any p0, Any p1) { invoke<Void>(0xCE87DA6F, p0, p1); } // 0xCE87DA6F
    static void SET_BLIP_DISPLAY(Any p0, Any p1) { invoke<Void>(0x2B521F91, p0, p1); } // 0x2B521F91
    static void SET_BLIP_CATEGORY(Any p0, Any p1) { invoke<Void>(0xEF72F533, p0, p1); } // 0xEF72F533
    static void REMOVE_BLIP(Any p0) { invoke<Void>(0xD8C3C1CD, p0); } // 0xD8C3C1CD
    static void SET_BLIP_AS_FRIENDLY(Any p0, Any p1) { invoke<Void>(0xF290CFD8, p0, p1); } // 0xF290CFD8
    ...
    static void SET_NEW_WAYPOINT(float a_fX, float a_fY) { invoke<Void>(0x8444E1F0, a_fX, a_fY); } // 0x8444E1F0
    ...
    static void _0x8A292AA3() { invoke<Void>(0x8A292AA3); } // 0x8A292AA3
    static void SET_WIDESCREEN_FORMAT(Any p0) { invoke<Void>(0xF016E08F, p0); } // 0xF016E08F
    static Any _0xB6507AD9() { invoke<Any>(0xB6507AD9); } // 0xB6507AD9
    ...
    static void _0x1EFFB02A(Any p0) { invoke<Void>(0x1EFFB02A, p0); } // 0x1EFFB02A
    ...
    static void _0x407C47FF(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x407C47FF, p0, p1, p2, p3, p4); } // 0x407C47FF
    ...
    static float _0xA4098ACC() { return invoke<float>(0xA4098ACC); } // 0xA4098ACC
    ...
    static BOOL IS_HUD_COMPONENT_ACTIVE(Any p0) { return invoke<BOOL>(0x6214631F, p0); } // 0x6214631F
    ...
    static void _0xE1BC7485(Any p0, Any p1) { invoke<Void>(0xE1BC7485, p0, p1); } // 0xE1BC7485
    ...
    static Any _0x3BE1257F(Any p0) { return invoke<Any>(0x3BE1257F, p0); } // 0x3BE1257F
...
namespace GRAPHICS
{
    static void SET_DEBUG_LINES_AND_SPHERES_DRAWING_ACTIVE(Any p0) { invoke<Void>(0x1418CA37, p0); } // 0x1418CA37
    ...
    static void DRAW_DEBUG_TEXT_2D(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0x528B973B, p0, p1, p2, p3, p4, p5, p6, p7); } // 0x528B973B
    static void DRAW_LINE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9) { invoke<Void>(0xB3426BCC, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); } // 0xB3426BCC
    ...
    static Any _0x83C846A0(Any p0) { return invoke<Any>(0x83C846A0, p0); } // 0x83C846A0
    static Any _0x5A59A24A(Any p0) { return invoke<Any>(0x5A59A24A, p0); } // 0x5A59A24A
    static Any _0x56C1E488(Any p0) { return invoke<Any>(0x56C1E488, p0); } // 0x56C1E488
    ...
    static void DRAW_LIGHT_WITH_RANGE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0x6A396E9A, p0, p1, p2, p3, p4, p5, p6, p7); } // 0x6A396E9A
    static void DRAW_SPOT_LIGHT(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13) { invoke<Void>(0xBDBC410C, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13); } // 0xBDBC410C
    ...
    static void DRAW_MARKER(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13, Any p14, Any p15, Any p16, Any p17, Any p18, Any p19, Any p20, Any p21, Any p22, Any p23) { invoke<Void>(0x48D84A02, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23); } // 0x48D84A02
    ...
    static void SET_CHECKPOINT_RGBA(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0xEF9C8CB3, p0, p1, p2, p3, p4); } // 0xEF9C8CB3
    ...
    static void REQUEST_STREAMED_TEXTURE_DICT(Any p0, Any p1) { invoke<Void>(0x4C9B035F, p0, p1); } // 0x4C9B035F
    static BOOL HAS_STREAMED_TEXTURE_DICT_LOADED(Any p0) { return invoke<BOOL>(0x3F436EEF, p0); } // 0x3F436EEF
    static void SET_STREAMED_TEXTURE_DICT_AS_NO_LONGER_NEEDED(Any p0) { invoke<Void>(0xF07DDA38, p0); } // 0xF07DDA38
    static void DRAW_RECT(float x1, float y1, float x2, float y2, int r, int g, int b, int a) { invoke<Void>(0xDD2BFC77, x1, y1, x2, y2, r, g, b, a); } // 0xDD2BFC77
    ...
    static void DRAW_SPRITE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10) { invoke<Void>(0x1FEC16B0, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); } // 0x1FEC16B0
    static Any ADD_ENTITY_ICON(Any p0, Any p1) { return invoke<Any>(0xF3027D21, p0, p1); } // 0xF3027D21
    static Any ADD_ENTITY_ICON_BY_VECTOR(Any p0, Any p1, Any p2, Any p3) { return invoke<Any>(0x49C4B137, p0, p1, p2, p3); } // 0x49C4B137
    static BOOL DOES_ENTITY_HAVE_ICON_ID(Any p0) { return invoke<BOOL>(0x1D244044, p0); } // 0x1D244044
    static void SET_ENTITY_ICON_VISIBILITY(Any p0, Any p1) { invoke<Void>(0xD1D2FD52, p0, p1); } // 0xD1D2FD52
    static void SET_ENTITY_ICON_ID_VISIBILITY(Any p0, Any p1) { invoke<Void>(0x1D61FACC, p0, p1); } // 0x1D61FACC
    static void _0x7722F545(Any p0, Any p1) { invoke<Void>(0x7722F545, p0, p1); } // 0x7722F545
    static void SET_ENTITY_ICON_COLOR(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x6EE1E946, p0, p1, p2, p3, p4); } // 0x6EE1E946
    static void SET_ENTITY_ICON_ID_COLOR(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x857DF02F, p0, p1, p2, p3, p4); } // 0x857DF02F
    static void _0x173F2EB3(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x173F2EB3, p0, p1, p2, p3, p4); } // 0x173F2EB3
    ...
    static BOOL GET_IS_HIDEF() { return invoke<BOOL>(0x1C340359); } // 0x1C340359
    static void SET_NIGHTVISION(Any p0) { invoke<Void>(0xD1E5565F, p0); } // 0xD1E5565F
    ...
    static Any CREATE_TRACKED_POINT() { return invoke<Any>(0x3129C31A); } // 0x3129C31A
    static void SET_TRACKED_POINT_INFO(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x28689AA4, p0, p1, p2, p3, p4); } // 0x28689AA4
    ...
    static void _0xB19B2764(Any p0) { invoke<Void>(0xB19B2764, p0); } // 0xB19B2764
    ...
    static void SET_SEETHROUGH(Any p0) { invoke<Void>(0x74D4995C, p0); } // 0x74D4995C
    ...
    static void SET_TIMECYCLE_MODIFIER(Any p0) { invoke<Void>(0xA81F3638, p0); } // 0xA81F3638
    ...
    static void _0x1D980479(Any p0, Any p1, Any p2) { invoke<Void>(0x1D980479, p0, p1, p2); } // 0x1D980479
...
namespace STATS
{
    ...
    static Any STAT_SAVE(Any p0, Any p1, Any p2) { return invoke<Any>(0xE10A7CA4, p0, p1, p2); } // 0xE10A7CA4
    ...
    static BOOL STAT_SET_INT(Hash stat, int value, int unk) { return invoke<BOOL>(0xC9CC1C5C, stat, value, unk); } // 0xC9CC1C5C
    static Any STAT_SET_FLOAT(Any p0, Any p1, Any p2) { return invoke<Any>(0x6CEA96F2, p0, p1, p2); } // 0x6CEA96F2
    static Any STAT_SET_BOOL(Any p0, Any p1, Any p2) { return invoke<Any>(0x55D79DFB, p0, p1, p2); } // 0x55D79DFB
    ...
    static Any STAT_SET_STRING(Any p0, Any p1, Any p2) { return invoke<Any>(0xB1EF2E21, p0, p1, p2); } // 0xB1EF2E21
    ...
    static BOOL STAT_GET_INT(Hash stat, int *pValue, int unk) { return invoke<BOOL>(0x1C6FE43E, stat, pValue, unk); } // 0x1C6FE43E
    static Any STAT_GET_FLOAT(Any p0, Any p1, Any p2) { return invoke<Any>(0xFCBDA612, p0, p1, p2); } // 0xFCBDA612
    static Any STAT_GET_BOOL(Any p0, Any p1, Any p2) { return invoke<Any>(0x28A3DD2B, p0, p1, p2); } // 0x28A3DD2B
    ...
    static void STAT_INCREMENT(Any p0, Any p1) { invoke<Void>(0xDFC5F71E, p0, p1); } // 0xDFC5F71E
    ...
    static void PLAYSTATS_POST_MATCH_BLOB(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13, Any p14, Any p15) { invoke<Void>(0x036B42BD, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15); } // 0x036B42BD
    ...
    static void PLAYSTATS_MATCH_ENDED(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0xF5CAB247, p0, p1, p2, p3, p4, p5); } // 0xF5CAB247
    ...
    static void _0x04181752(Any p0, Any p1, Any p2) { invoke<Void>(0x04181752, p0, p1, p2); } // 0x04181752
...
namespace APP
{
    ...
    static Any APP_HAS_SYNCED_DATA(Any p0) { return invoke<Any>(0x1DE2A63D, p0); } // 0x1DE2A63D
...
namespace TIME
{
    static void SET_CLOCK_TIME(int h, int m, int s) { invoke<Void>(0x26F6AF14, h, m, s); } // 0x26F6AF14
    static void PAUSE_CLOCK(BOOL b) { invoke<Void>(0xB02D6124, b); } // 0xB02D6124
    static void _0x57B8DA7C(int h, int m, int s) { invoke<Void>(0x57B8DA7C, h, m, s); } // 0x57B8DA7C
    static void ADD_TO_CLOCK_TIME(int h, int m, int s) { invoke<Void>(0xCC40D20D, h, m, s); } // 0xCC40D20D
...
namespace PATHFIND
{
    ...
    static Any GET_SAFE_COORD_FOR_PED(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { return invoke<Any>(0xB370270A, p0, p1, p2, p3, p4, p5); } // 0xB370270A
    static Any GET_CLOSEST_VEHICLE_NODE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { return invoke<Any>(0x6F5F1E6C, p0, p1, p2, p3, p4, p5, p6); } // 0x6F5F1E6C
...
namespace CONTROLS
{
    static BOOL IS_CONTROL_ENABLED(Any p0, Any p1) { return invoke<BOOL>(0x9174AF84, p0, p1); } // 0x9174AF84
    static BOOL IS_CONTROL_PRESSED(Any p0, Any p1) { return invoke<BOOL>(0x517A4384, p0, p1); } // 0x517A4384
    static BOOL IS_CONTROL_RELEASED(Any p0, Any p1) { return invoke<BOOL>(0x1F91A06E, p0, p1); } // 0x1F91A06E
    static BOOL IS_CONTROL_JUST_PRESSED(Any p0, Any p1) { return invoke<BOOL>(0x4487F579, p0, p1); } // 0x4487F579
    static BOOL IS_CONTROL_JUST_RELEASED(Any p0, Any p1) { return invoke<BOOL>(0x2314444B, p0, p1); } // 0x2314444B
    ...
    static BOOL IS_DISABLED_CONTROL_PRESSED(Any p0, Any p1) { return invoke<BOOL>(0x32A93544, p0, p1); } // 0x32A93544
    static BOOL IS_DISABLED_CONTROL_JUST_PRESSED(Any p0, Any p1) { return invoke<BOOL>(0xEE6ABD32, p0, p1); } // 0xEE6ABD32
    static BOOL IS_DISABLED_CONTROL_JUST_RELEASED(Any p0, Any p1) { return invoke<BOOL>(0xD6A679E1, p0, p1); } // 0xD6A679E1
    ...
    static Any _0x81802053() { return invoke<Any>(0x81802053); } // 0x81802053
    static void SET_PLAYERPAD_SHAKES_WHEN_CONTROLLER_DISABLED(Any p0) { invoke<Void>(0xA86BD91F, p0); } // 0xA86BD91F
    static void SET_INPUT_EXCLUSIVE(Any p0, Any p1) { invoke<Void>(0x4E8E29E6, p0, p1); } // 0x4E8E29E6
    static void DISABLE_CONTROL_ACTION(Any p0, Any p1) { invoke<Void>(0x3800C0DC, p0, p1); } // 0x3800C0DC
    static void ENABLE_CONTROL_ACTION(Any p0, Any p1) { invoke<Void>(0xD2753551, p0, p1); } // 0xD2753551
    static void DISABLE_ALL_CONTROL_ACTIONS(Any p0) { invoke<Void>(0x16753CF4, p0); } // 0x16753CF4
    static void ENABLE_ALL_CONTROL_ACTIONS(Any p0) { invoke<Void>(0xFC2F119F, p0); } // 0xFC2F119F
    static Any _0xD2C80B2E(Any p0) { return invoke<Any>(0xD2C80B2E, p0); } // 0xD2C80B2E
...
namespace DATAFILE
{
    ...
    static void _0x5B39D0AC() { invoke<Void>(0x5B39D0AC); } // 0x5B39D0AC
...
namespace FIRE
{
    ...
    static Any START_ENTITY_FIRE(Any p0) { return invoke<Any>(0x8928428E, p0); } // 0x8928428E
    static void STOP_ENTITY_FIRE(Any p0) { invoke<Void>(0xCE8C9066, p0); } // 0xCE8C9066
    ...
    static void ADD_EXPLOSION(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0x10AF5258, p0, p1, p2, p3, p4, p5, p6, p7); } // 0x10AF5258
    static void ADD_OWNED_EXPLOSION(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0x27EE0D67, p0, p1, p2, p3, p4, p5, p6, p7, p8); } // 0x27EE0D67
    static void _0xCF358946(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0xCF358946, p0, p1, p2, p3, p4, p5, p6, p7, p8); } // 0xCF358946
...
namespace ZONE
{
    static Any GET_ZONE_AT_COORDS(Any p0, Any p1, Any p2) { return invoke<Any>(0xC9018181, p0, p1, p2); } // 0xC9018181
    ...
    static Any GET_NAME_OF_ZONE(Any p0, Any p1, Any p2) { return invoke<Any>(0x7875CE91, p0, p1, p2); } // 0x7875CE91
...
namespace ROPE
{
    static Any ADD_ROPE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13, Any p14, Any p15, Any p16) { return invoke<Any>(0xA592EC74, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16); } // 0xA592EC74
    static void DELETE_ROPE(Any p0) { invoke<Void>(0x748D72AF, p0); } // 0x748D72AF
    static void DELETE_CHILD_ROPE(Any p0) { invoke<Void>(0xB19B4706, p0); } // 0xB19B4706
    static BOOL DOES_ROPE_EXIST(Any p0) { return invoke<BOOL>(0x66E4A3AC, p0); } // 0x66E4A3AC
    static void _0x51523B8C(Any p0, Any p1) { invoke<Void>(0x51523B8C, p0, p1); } // 0x51523B8C
    static void LOAD_ROPE_DATA(Any p0, Any p1) { invoke<Void>(0x9E8F1644, p0, p1); } // 0x9E8F1644
    static void PIN_ROPE_VERTEX(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0xAE1D101B, p0, p1, p2, p3, p4); } // 0xAE1D101B
    static void UNPIN_ROPE_VERTEX(Any p0, Any p1) { invoke<Void>(0xB30B552F, p0, p1); } // 0xB30B552F
    static Any GET_ROPE_VERTEX_COUNT(Any p0) { return invoke<Any>(0x5131CD2C, p0); } // 0x5131CD2C
    static void ATTACH_ENTITIES_TO_ROPE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13) { invoke<Void>(0x7508668F, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13); } // 0x7508668F
    static void ATTACH_ROPE_TO_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0xB25D9536, p0, p1, p2, p3, p4, p5); } // 0xB25D9536
    static void DETACH_ROPE_FROM_ENTITY(Any p0, Any p1) { invoke<Void>(0x3E720BEE, p0, p1); } // 0x3E720BEE
    ...
    static Vector3 GET_ROPE_LAST_VERTEX_COORD(Any p0) { return invoke<Vector3>(0x91F6848B, p0); } // 0x91F6848B
    static Vector3 GET_ROPE_VERTEX_COORD(Any p0, Any p1) { return invoke<Vector3>(0x84374452, p0, p1); } // 0x84374452
    ...
    static void ROPE_FORCE_LENGTH(Any p0, Any p1) { invoke<Void>(0xABF3130F, p0, p1); } // 0xABF3130F
    static void ROPE_RESET_LENGTH(Any p0, Any p1) { invoke<Void>(0xC8A423A3, p0, p1); } // 0xC8A423A3
    ...
    static void ACTIVATE_PHYSICS(Any p0) { invoke<Void>(0x031711B8, p0); } // 0x031711B8
    ...
    static void SET_DISABLE_BREAKING(Any p0, Any p1) { invoke<Void>(0xEE77C326, p0, p1); } // 0xEE77C326
    static void _0x97269DC8(Any p0, Any p1) { invoke<Void>(0x97269DC8, p0, p1); } // 0x97269DC8
}
namespace WATER
{
    static BOOL GET_WATER_HEIGHT(float x, float y, float z, float *h) { return invoke<BOOL>(0xD864E17C, x, y, z, h); } // 0xD864E17C
    static BOOL GET_WATER_HEIGHT_NO_WAVES(float x, float y, float z, float *h) { return invoke<BOOL>(0x262017F8, x, y, z, h); } // 0x262017F8
    ...
    static void MODIFY_WATER(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xC49E005A, p0, p1, p2, p3); } // 0xC49E005A
}
...
namespace NETWORK
{
    ...
    static Any NETWORK_IS_ROCKSTAR_DEV() { return invoke<Any>(0x3A59BC68); } // 0x3A59BC68
    ...
    static Any _0x2D817A5E(Any p0) { return invoke<Any>(0x2D817A5E, p0); } // 0x2D817A5E
    ...
    static Any NETWORK_GET_ACTIVITY_PLAYER_MAX(Any p0) { return invoke<Any>(0xB98F7056, p0); } // 0xB98F7056
    ...
    static Any NETWORK_INVITE_GAMER_TO_TRANSITION(Any p0) { return invoke<Any>(0xB8886E39, p0); } // 0xB8886E39
    ...
    static Any NETWORK_DO_TRANSITION_TO_NEW_FREEMODE(Any p0, Any p1, Any p2, Any p3) { return invoke<Any>(0xAD13375E, p0, p1, p2, p3); } // 0xAD13375E
    ...
    static Any _0x54739CDB() { return invoke<Any>(0x54739CDB); } // 0x54739CDB
    ...
    static Any NETWORK_INVITE_GAMER(Any p0) { return invoke<Any>(0x8D9D373C, p0); } // 0x8D9D373C
    ...
    static Any _0x08DC74F2() { return invoke<Any>(0x08DC74F2); } // 0x08DC74F2
    ...
    static BOOL IS_GAMERTAG_CACHE_RELOADED(Any p0) { return invoke<BOOL>(0x3742F25D, p0); } // 0x3742F25D
    ...
    static Any _0xB6F7E208(Any p0, Any p1) { return invoke<Any>(0xB6F7E208, p0, p1); } // 0xB6F7E208
    ...
    static Any NETWORK_GET_PLAYER_INDEX(Any p0) { return invoke<Any>(0xBE1C1506, p0); } // 0xBE1C1506
    ...
    static Any NETWORK_GET_NUM_CONNECTED_PLAYERS() { return invoke<Any>(0xF7952E62); } // 0xF7952E62
    ...
    static Any NETWORK_GET_KILLER_OF_PLAYER(Any p0, Any p1) { return invoke<Any>(0x9809FB6F, p0, p1); } // 0x9809FB6F
    ...
    static Any NETWORK_REQUEST_CONTROL_OF_NETWORK_ID(Any p0) { return invoke<Any>(0x9262A60A, p0); } // 0x9262A60A
    static Any NETWORK_HAS_CONTROL_OF_NETWORK_ID(Any p0) { return invoke<Any>(0x92E77D21, p0); } // 0x92E77D21
    static Any NETWORK_REQUEST_CONTROL_OF_ENTITY(Any p0) { return invoke<Any>(0xA05FEBD7, p0); } // 0xA05FEBD7
    static Any NETWORK_REQUEST_CONTROL_OF_DOOR(Any p0) { return invoke<Any>(0xF60DAAF6, p0); } // 0xF60DAAF6
    static Any NETWORK_HAS_CONTROL_OF_ENTITY(Any p0) { return invoke<Any>(0x005FD797, p0); } // 0x005FD797
    ...
    static Any VEH_TO_NET(Any p0) { return invoke<Any>(0xF17634EB, p0); } // 0xF17634EB
    static Any PED_TO_NET(Any p0) { return invoke<Any>(0x86A0B759, p0); } // 0x86A0B759
    static Any OBJ_TO_NET(Any p0) { return invoke<Any>(0x1E05F29F, p0); } // 0x1E05F29F
    ...
    static void NETWORK_HANDLE_FROM_PLAYER(Any p0, Any p1, Any p2) { invoke<Void>(0xD3498917, p0, p1, p2); } // 0xD3498917
    ...
    static Any NETWORK_PLAYER_IS_ROCKSTAR_DEV(Any p0) { return invoke<Any>(0xF6659045, p0); } // 0xF6659045
    ...
    static Any NETWORK_SET_PLAYER_MUTED(Any p0, Any p1) { return invoke<Any>(0xCE451908, p0, p1); } // 0xCE451908
    ...
    static void _0x6BEE48AA(Any p0, Any p1) { invoke<Void>(0x6BEE48AA, p0, p1); } // 0x6BEE48AA
    ...
    static void SET_NETWORK_ID_EXISTS_ON_ALL_MACHINES(Any p0, Any p1) { invoke<Void>(0x68D486B2, p0, p1); } // 0x68D486B2
    ...
    static void SET_LOCAL_PLAYER_VISIBLE_LOCALLY() { invoke<Void>(0x324B56DB); } // 0x324B56DB
    static void SET_PLAYER_INVISIBLE_LOCALLY(Any p0) { invoke<Void>(0x18227209, p0); } // 0x18227209
    ...
    static void NETWORK_SET_IN_MP_CUTSCENE(Any p0, Any p1) { invoke<Void>(0x8434CB43, p0, p1); } // 0x8434CB43
    ...
    static void NETWORK_OVERRIDE_CLOCK_TIME(Any p0, Any p1, Any p2) { invoke<Void>(0xC077BCD6, p0, p1, p2); } // 0xC077BCD6
    ...
    static Any _0x1877D451(Any p0, Any p1) { return invoke<Any>(0x1877D451, p0, p1); } // 0x1877D451
    ...
    static Any CLOUD_REQUEST_MEMBER_FILE(Any p0, Any p1, Any p2) { return invoke<Any>(0xB9B3B4D9, p0, p1, p2); } // 0xB9B3B4D9
    ...
    static Any _0x4609D596(Any p0, Any p1, Any p2) { return invoke<Any>(0x4609D596, p0, p1, p2); } // 0x4609D596
    static Any _0x4C2C0D1F(Any p0, Any p1, Any p2) { return invoke<Any>(0x4C2C0D1F, p0, p1, p2); } // 0x4C2C0D1F
    static Any _0x6B99ACFD(Any p0, Any p1, Any p2) { return invoke<Any>(0x6B99ACFD, p0, p1, p2); } // 0x6B99ACFD
    static Any _0xA4351C31(Any p0, Any p1, Any p2) { return invoke<Any>(0xA4351C31, p0, p1, p2); } // 0xA4351C31
    static Any _0x9EFBD5D1(Any p0, Any p1, Any p2) { return invoke<Any>(0x9EFBD5D1, p0, p1, p2); } // 0x9EFBD5D1
    static Any _0xA6D8B798(Any p0, Any p1, Any p2, Any p3) { return invoke<Any>(0xA6D8B798, p0, p1, p2, p3); } // 0xA6D8B798
    static Any _0x67E74842(Any p0, Any p1, Any p2, Any p3) { return invoke<Any>(0x67E74842, p0, p1, p2, p3); } // 0x67E74842
    ...
    static Any _0x37F5BD93(Any p0, Any p1, Any p2) { return invoke<Any>(0x37F5BD93, p0, p1, p2); } // 0x37F5BD93
    static Any _0x1CFB3F51(Any p0, Any p1, Any p2) { return invoke<Any>(0x1CFB3F51, p0, p1, p2); } // 0x1CFB3F51
    static Any _0x87D1E6BD(Any p0, Any p1, Any p2) { return invoke<Any>(0x87D1E6BD, p0, p1, p2); } // 0x87D1E6BD
    ...
    static Any _0x0303EC6E(Any p0) { return invoke<Any>(0x0303EC6E, p0); } // 0x0303EC6E
    ...
    static Any _0x899E468D(Any p0, Any p1, Any p2) { return invoke<Any>(0x899E468D, p0, p1, p2); } // 0x899E468D
    ...
    static Any _0x983D1B97(Any p0, Any p1, Any p2) { return invoke<Any>(0x983D1B97, p0, p1, p2); } // 0x983D1B97
    ...
    static Any _0x094852B0() { return invoke<Any>(0x094852B0); } // 0x094852B0
    ...
    static void _0x0D4F845D(Any p0) { invoke<Void>(0x0D4F845D, p0); } // 0x0D4F845D
    ...
    static Any _0x774F349D(Any p0) { return invoke<Any>(0x774F349D, p0); } // 0x774F349D
    ...
    static Any _0x68C9AF69(Any p0, Any p1, Any p2) { return invoke<Any>(0x68C9AF69, p0, p1, p2); } // 0x68C9AF69
...
namespace NETWORKCASH
{
    ...
    static void NETWORK_SPENT_BUY_WANTEDLEVEL(Any p0, Any p1, Any p2) { invoke<Void>(0xE7CB4F95, p0, p1, p2); } // 0xE7CB4F95
    ...
    static void _0x66DA9935(Any p0) { invoke<Void>(0x66DA9935, p0); } // 0x66DA9935
    static void NETWORK_DELETE_CHARACTER(Any p0) { invoke<Void>(0xA9F7E9C3, p0); } // 0xA9F7E9C3
    static Any _0x63F093A6() { return invoke<Any>(0x63F093A6); } // 0x63F093A6
    ...
    static void NETWORK_EARN_FROM_PICKUP(Any p0) { invoke<Void>(0x70A0ED62, p0); } // 0x70A0ED62
    static void _0x30B3EC0A(Any p0) { invoke<Void>(0x30B3EC0A, p0); } // 0x30B3EC0A
    static void _0xC7A825EB(Any p0) { invoke<Void>(0xC7A825EB, p0); } // 0xC7A825EB
    static void _0xED618DA9(Any p0, Any p1) { invoke<Void>(0xED618DA9, p0, p1); } // 0xED618DA9
    ...
    static void NETWORK_EARN_FROM_JOB(Any p0, Any p1) { invoke<Void>(0x0B6997FC, p0, p1); } // 0x0B6997FC
    ...
    static void _0x866004A8(Any p0) { invoke<Void>(0x866004A8, p0); } // 0x866004A8
    ...
    static void NETWORK_SPENT_TAXI(Any p0, Any p1) { invoke<Void>(0x1F3DB3E3, p0, p1); } // 0x1F3DB3E3
    static void _0xBE70849B(Any p0, Any p1) { invoke<Void>(0xBE70849B, p0, p1); } // 0xBE70849B
    static void _0x451A2644(Any p0, Any p1) { invoke<Void>(0x451A2644, p0, p1); } // 0x451A2644
    static void _0x224A3488(Any p0, Any p1, Any p2) { invoke<Void>(0x224A3488, p0, p1, p2); } // 0x224A3488
    static void NETWORK_SPENT_BETTING(Any p0, Any p1, Any p2) { invoke<Void>(0xF8A07513, p0, p1, p2); } // 0xF8A07513
    static void _0x8957038E(Any p0, Any p1, Any p2) { invoke<Void>(0x8957038E, p0, p1, p2); } // 0x8957038E
    static void NETWORK_BUY_HEALTHCARE(Any p0, Any p1) { invoke<Void>(0x832150E5, p0, p1); } // 0x832150E5
    static void NETWORK_BUY_AIRSTRIKE(Any p0, Any p1) { invoke<Void>(0x40470683, p0, p1); } // 0x40470683
    static void _0x2AD2EC51(Any p0, Any p1, Any p2) { invoke<Void>(0x2AD2EC51, p0, p1, p2); } // 0x2AD2EC51
    static void _0x047547D4(Any p0, Any p1) { invoke<Void>(0x047547D4, p0, p1); } // 0x047547D4
    static void NETWORK_SPENT_AMMO_DROP(Any p0, Any p1) { invoke<Void>(0x4B643076, p0, p1); } // 0x4B643076
    static void NETWORK_BUY_BOUNTY(Any p0, Any p1, Any p2) { invoke<Void>(0xCB89CBE0, p0, p1, p2); } // 0xCB89CBE0
    static void NETWORK_BUY_PROPERTY(Any p0, Any p1, Any p2) { invoke<Void>(0x7D479AAB, p0, p1, p2); } // 0x7D479AAB
    static void NETWORK_BUY_SMOKES(Any p0, Any p1) { invoke<Void>(0xC0AB03EB, p0, p1); } // 0xC0AB03EB
    static void NETWORK_SPENT_HELI_PICKUP(Any p0, Any p1) { invoke<Void>(0x27EEBCAB, p0, p1); } // 0x27EEBCAB
    static void NETWORK_SPENT_BOAT_PICKUP(Any p0, Any p1) { invoke<Void>(0xB241CABD, p0, p1); } // 0xB241CABD
    static void _0xDE7D398C(Any p0, Any p1) { invoke<Void>(0xDE7D398C, p0, p1); } // 0xDE7D398C
    static void NETWORK_SPENT_CASH_DROP(Any p0) { invoke<Void>(0x87BD1D11, p0); } // 0x87BD1D11
    static void _0xE792C4A5(Any p0, Any p1) { invoke<Void>(0xE792C4A5, p0, p1); } // 0xE792C4A5
    static void _0xE6AAA0D5(Any p0, Any p1) { invoke<Void>(0xE6AAA0D5, p0, p1); } // 0xE6AAA0D5
    static void _0x99CF02C4(Any p0, Any p1) { invoke<Void>(0x99CF02C4, p0, p1); } // 0x99CF02C4
    static void _0x20DDCF2F(Any p0, Any p1) { invoke<Void>(0x20DDCF2F, p0, p1); } // 0x20DDCF2F
    static void _0x2F7836E2(Any p0, Any p1) { invoke<Void>(0x2F7836E2, p0, p1); } // 0x2F7836E2
    static void NETWORK_SPENT_CARWASH(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x8283E028, p0, p1, p2, p3); } // 0x8283E028
    static void NETWORK_SPENT_CINEMA(Any p0, Any p1, Any p2) { invoke<Void>(0x1100CAF5, p0, p1, p2); } // 0x1100CAF5
    static void NETWORK_SPENT_TELESCOPE(Any p0, Any p1) { invoke<Void>(0xAE7FF044, p0, p1); } // 0xAE7FF044
    static void NETWORK_SPENT_HOLDUPS(Any p0, Any p1) { invoke<Void>(0x1B3803B1, p0, p1); } // 0x1B3803B1
    static void _0x7E97C92C(Any p0, Any p1) { invoke<Void>(0x7E97C92C, p0, p1); } // 0x7E97C92C
    ...
    static Any _0x0EA2188C(Any p0, Any p1) { return invoke<Any>(0x0EA2188C, p0, p1); } // 0x0EA2188C
...
namespace DLC1
{
    ...
    static Any _0x8EAF9CF6() { return invoke<Any>(0x8EAF9CF6); } // 0x8EAF9CF6
...
namespace DLC2
{
    static BOOL IS_DLC_PRESENT(Any p0) { return invoke<BOOL>(0x1F321943, p0); } // 0x1F321943
...
namespace SYSTEM
{
    static void WAIT(Any p0) { invoke<Void>(0x7715C03B, p0); } // 0x7715C03B
    // WAITUNWARPED -- no params/results data
    // WAITUNPAUSED -- no params/results data
    static int START_NEW_SCRIPT(LPSTR name, int stack) { return invoke<int>(0x3F166D0E, name, stack); } // 0x3F166D0E
    static int START_NEW_SCRIPT_WITH_ARGS(LPSTR name, Any p1, Any p2, Any p3) { return invoke<int>(0x4A2100E4, name, p1, p2, p3); } // 0x4A2100E4
    static Any TIMERA() { return invoke<Any>(0x45C8C188); } // 0x45C8C188
    static Any TIMERB() { return invoke<Any>(0x330A9C0C); } // 0x330A9C0C
    static void SETTIMERA(Any p0) { invoke<Void>(0x35785333, p0); } // 0x35785333
    static void SETTIMERB(Any p0) { invoke<Void>(0x27C1B7C6, p0); } // 0x27C1B7C6
    static Any TIMESTEP() { return invoke<Any>(0x50597EE2); } // 0x50597EE2
    static Any SIN(Any p0) { return invoke<Any>(0xBF987F58, p0); } // 0xBF987F58
    static Any COS(Any p0) { return invoke<Any>(0x00238FE9, p0); } // 0x00238FE9
    static Any SQRT(Any p0) { return invoke<Any>(0x145C7701, p0); } // 0x145C7701
    static Any POW(Any p0, Any p1) { return invoke<Any>(0x85D134F8, p0, p1); } // 0x85D134F8
    static Any VMAG(Any p0, Any p1, Any p2) { return invoke<Any>(0x1FCF1ECD, p0, p1, p2); } // 0x1FCF1ECD
    static Any VMAG2(Any p0, Any p1, Any p2) { return invoke<Any>(0xE796E629, p0, p1, p2); } // 0xE796E629
    static Any VDIST(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { return invoke<Any>(0x3C08ECB7, p0, p1, p2, p3, p4, p5); } // 0x3C08ECB7
    static Any VDIST2(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { return invoke<Any>(0xC85DEF1F, p0, p1, p2, p3, p4, p5); } // 0xC85DEF1F
    static Any SHIFT_LEFT(Any p0, Any p1) { return invoke<Any>(0x314CC6CD, p0, p1); } // 0x314CC6CD
    static Any SHIFT_RIGHT(Any p0, Any p1) { return invoke<Any>(0x352633CA, p0, p1); } // 0x352633CA
    static Any FLOOR(Any p0) { return invoke<Any>(0x32E9BE04, p0); } // 0x32E9BE04
    static Any CEIL(Any p0) { return invoke<Any>(0xD536A1DF, p0); } // 0xD536A1DF
    static Any ROUND(Any p0) { return invoke<Any>(0x323B0E24, p0); } // 0x323B0E24
    static Any TO_FLOAT(Any p0) { return invoke<Any>(0x67116627, p0); } // 0x67116627
    static void CLEAR_TEXT_LABEL(Any p0) { invoke<Void>(0xA66AAE8F, p0); } // 0xA66AAE8F
}
namespace DECORATOR
{
...
namespace UNK_SC
{
    ...
    static Any _0xCABD136A(Any p0, Any p1, Any p2) { return invoke<Any>(0xCABD136A, p0, p1, p2); } // 0xCABD136A
...
namespace UNK
{
    static Any _0x106C8317() { return invoke<Any>(0x106C8317); } // 0x106C8317
    static Any _0xD87F3A9E() { return invoke<Any>(0xD87F3A9E); } // 0xD87F3A9E
    static void _0xC0B971EA(Any p0) { invoke<Void>(0xC0B971EA, p0); } // 0xC0B971EA
    ...
    static Any _0x9451EFE7() { return invoke<Any>(0x9451EFE7); } // 0x9451EFE7
